/datum/design/health_hud_prescription
	...
	materials = list(/datum/material/iron = 500, /datum/material/glass = 500, /datum/material/silver = SMALL_MATERIAL_AMOUNT * 4)
...
/datum/design/diagnostic_hud_prescription
	...
	build_type = PROTOLATHE | AWAY_LATHE
	materials = list(/datum/material/iron = 500, /datum/material/glass = 500, /datum/material/gold = SMALL_MATERIAL_AMOUNT * 4)
...
/datum/design/engine_goggles_prescription
	...
	build_type = PROTOLATHE | AWAY_LATHE
	materials = list(/datum/material/iron = 500, /datum/material/glass = 500, /datum/material/plasma = 100, /datum/material/silver = SMALL_MATERIAL_AMOUNT * 4)
