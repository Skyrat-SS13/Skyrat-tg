/obj/item/clothing/suit/toggle/labcoat/security_medic
	...
	icon = 'modular_skyrat/modules/sec_haul/icons/security_medic/secmed_items.dmi'
	worn_icon = 'modular_skyrat/modules/sec_haul/icons/security_medic/secmed_suits.dmi'
	armor = list(MELEE = 10, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 0, BIO = 10, RAD = 0, FIRE = 50, ACID = 50, WOUND = 10)
...
/obj/item/clothing/under/rank/security/peacekeeper/security_medic
	...
	icon = 'modular_skyrat/modules/sec_haul/icons/security_medic/secmed_items.dmi'
	worn_icon = 'modular_skyrat/modules/sec_haul/icons/security_medic/secmed_uniform.dmi'
	worn_icon_digi = 'modular_skyrat/modules/sec_haul/icons/security_medic/secmed_uniform_digi.dmi'
...
/obj/item/clothing/head/beret/sec/peacekeeper/security_medic
	...
	icon = 'modular_skyrat/modules/sec_haul/icons/security_medic/secmed_items.dmi'
	worn_icon = 'modular_skyrat/modules/sec_haul/icons/security_medic/secmed_head.dmi'
