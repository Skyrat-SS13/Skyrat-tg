...
/obj/item/clothing/under/rank/security/peacekeeper/sergeant
	...
	desc = "A sleek peackeeper uniform, this one is special. It's for sergeants."
	icon_state = "peacekeeper_sergeant"
	armor = list(MELEE = 15, BULLET = 5, LASER = 0,ENERGY = 0, BOMB = 0, BIO = 0, RAD = 0, FIRE = 30, ACID = 30, WOUND = 10)
