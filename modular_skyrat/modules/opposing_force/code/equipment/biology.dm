...
/datum/opposing_force_equipment/biology
	category = OPFOR_EQUIPMENT_CATEGORY_BIO

/datum/opposing_force_equipment/biology/xeno
...
/datum/opposing_force_equipment/biology/xeno_eggsac
