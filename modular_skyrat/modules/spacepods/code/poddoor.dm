 ...
 * Pod doors
 *
 * Great for mapping helpers and they open automatically for pods!
 */
...
/obj/machinery/door/poddoor/multi_tile/proc/apply_opacity_to_my_turfs(new_opacity)
	for(var/turf/iterating_turf in locs)
		iterating_turf.opacity = new_opacity
		iterating_turf.reconsider_lights()
		iterating_turf.air_update_turf(1)
	update_freelook_sight()

/obj/machinery/door/poddoor/multi_tile/four_tile_ver
	icon = 'modular_skyrat/modules/spacepods/icons/doors/1x4blast_vert.dmi'
	bound_height = 128
	dir = NORTH

/obj/machinery/door/poddoor/multi_tile/three_tile_ver
	icon = 'modular_skyrat/modules/spacepods/icons/doors/1x3blast_vert.dmi'
	bound_height = 96
	dir = NORTH

/obj/machinery/door/poddoor/multi_tile/two_tile_ver
	icon = 'modular_skyrat/modules/spacepods/icons/doors/1x2blast_vert.dmi'
	bound_height = 64
	dir = NORTH

/obj/machinery/door/poddoor/multi_tile/four_tile_hor
	icon = 'modular_skyrat/modules/spacepods/icons/doors/1x4blast_hor.dmi'
	bound_width = 128
	dir = EAST

/obj/machinery/door/poddoor/multi_tile/three_tile_hor
	icon = 'modular_skyrat/modules/spacepods/icons/doors/1x3blast_hor.dmi'
	bound_width = 96
	dir = EAST

/obj/machinery/door/poddoor/multi_tile/two_tile_hor
	icon = 'modular_skyrat/modules/spacepods/icons/doors/1x2blast_hor.dmi'
	bound_width = 64
	dir = EAST
