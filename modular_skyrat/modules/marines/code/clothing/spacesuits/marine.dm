/obj/item/clothing/head/helmet/space/hardsuit/ert/marine
	...
	inhand_icon_state = "hardsuit0-marine" //should never be able to hold it anyways so what do i care :PPPP
...
/obj/item/clothing/head/helmet/space/hardsuit/ert/marine/Initialize()
	. = ..()
