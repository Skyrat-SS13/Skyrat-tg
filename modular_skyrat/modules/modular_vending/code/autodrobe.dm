/obj/machinery/vending/autodrobe
	skyrat_products = list(
		...
		/obj/item/clothing/under/costume/whiterussian = 5,
		/obj/item/clothing/under/misc/tactical1 = 5,
		/obj/item/clothing/under/costume/uvf = 5,
		/obj/item/clothing/under/costume/rancher/texas/doug_dimmadome = 5,
	...
	skyrat_contraband = list(
		...
		/obj/item/clothing/under/costume/imperial/grey/trouser = 5,
		/obj/item/clothing/under/costume/imperial/red = 5,
		/obj/item/clothing/under/costume/imperial/grey = 5,
		/obj/item/clothing/under/costume/imperial = 5,
	)
