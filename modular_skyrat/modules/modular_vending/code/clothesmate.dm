/obj/machinery/vending/clothing
	skyrat_products = list(
		...
		/obj/item/clothing/under/costume/rancher = 5,
		/obj/item/clothing/under/costume/rancher/pioneer = 5,
		/obj/item/clothing/under/costume/rancher/worker = 5,
		/obj/item/clothing/under/costume/rancher/cowboy = 5,
		/obj/item/clothing/under/costume/rancher/checkered = 5,
		/obj/item/clothing/under/costume/rancher/texas = 5,
		/obj/item/clothing/under/costume/rancher/texas/westender = 5,
