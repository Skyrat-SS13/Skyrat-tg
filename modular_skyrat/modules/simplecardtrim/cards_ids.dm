...
/datum/id_trim
	trim_icon = 'modular_skyrat/modules/simplecardtrim/card.dmi'
...
/datum/id_trim/job/lawyer
	trim_state = "trim_servicesecurity"
...
/datum/id_trim/job/psychologist
	trim_state = "trim_servicemedical"
