/datum/interaction/handshake
	...
	message = list("%USER% shakes %TARGET%'s hand.")
...
/datum/interaction/pat
	name = "Pat"
	category = INTERACTION_CAT_NONE
	message = list("%USER% pats %TARGET% on their shoulder.")
...
/datum/interaction/cheer
	...
	category = INTERACTION_CAT_NONE
	message = list("%USER% cheers for %TARGET%!")
...
/datum/interaction/highfive
	name = "Highfive"
	category = INTERACTION_CAT_NONE
	message = list("%USER% gives %TARGET% a highfive!")
...
/datum/interaction/pat/head
	name = "Headpat"
	message = list("%USER% pats %TARGET%'s head!")

/datum/interaction/salute
	name = "Salute"
	distance_allowed = TRUE
	category = INTERACTION_CAT_NONE
	message = list("%USER% snaps to a salute for %TARGET%!")
...
/datum/interaction/handshake/fistbumb
	name = "Fistbump"
	category = INTERACTION_CAT_NONE
	message = list("%USER% bumbs %TARGET%'s fist with theirs!")
