...
/obj/item/organ/lungs/hot
	...
	icon = 'modular_skyrat/modules/organs/lungs.dmi'
	desc = "A set of lungs adapted to high temperatures though more susceptible to low temperatures. Breathing hot gases will heal you depending on the temperature of the gas."
