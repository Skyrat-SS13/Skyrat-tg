...
/datum/gunpoint/Destroy()
	...
	UnregisterSignal(target, list(COMSIG_QDELETING, COMSIG_ITEM_INTERACTING_WITH_ATOM, COMSIG_ITEM_ATTACK_SELF, COMSIG_LIVING_UNARMED_ATTACK, COMSIG_ITEM_ATTACK_SELF, COMSIG_MOVABLE_RADIO_TALK_INTO, COMSIG_MOB_FIRED_GUN, COMSIG_MOVABLE_MOVED))
