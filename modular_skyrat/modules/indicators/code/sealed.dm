...
/obj/vehicle/sealed/add_occupant(mob/occupant_exiting, control_flags)
	RegisterSignal(occupant_exiting, COMSIG_MOB_CI_TOGGLED, .proc/mob_toggled_ci)
	. = ..()
	handle_ci_migration(occupant_exiting)
