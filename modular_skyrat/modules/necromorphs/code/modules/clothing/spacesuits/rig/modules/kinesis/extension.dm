...
//	hum = GLOB.sound_player.PlayLoopingSound(subject, "[rand(0, 99999)]", 'modular_skyrat/modules/necromorphs/sound/effects/rig/modules/kinesis_hold.ogg', VOLUME_MID_HIGH, world.view)
