...
/mob/living/simple_animal/hostile/necropuker
	...
	icon = 'modular_skyrat/modules/necromorphs/icons/mob/necromorph/puker.dmi'
	icon_state = "puker"
	icon_living = "puker"
...
//	see_invisible = SEE_INVISIBLE_MINIMUM
	...
	attack_sound = 'modular_skyrat/modules/necromorphs/sound/effects/creatures/necromorph/puker/puker_attack_1.ogg'
	deathsound = 'modular_skyrat/modules/necromorphs/sound/effects/creatures/necromorph/puker/puker_death_1.ogg'
...
/obj/projectile/neurotox
	name = "Puke"
	damage = 30
	icon = 'modular_skyrat/modules/necromorphs/icons/mob/necromorph/necroprojectiles.dmi'
	icon_state = "pukeshot"
/*
