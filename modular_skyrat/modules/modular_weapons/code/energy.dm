...
/obj/item/gun/energy/disabler/secmed
	name = "FMG disabler"
	desc = "A modified version of the standard NT disabler, the Field Medic Grade disabler is outfitted to shoot healing salve projectiles in additon to having a standard disable mode."
	icon = 'modular_skyrat/modules/modular_weapons/icons/obj/guns/projectile.dmi'
