/obj/structure/sign/poster/official/trappiste_suppressor
	...
	desc = "This poster depicts, alongside the prominent logo of Trappiste Fabriek, a diagram of the average suppressor, and how on most* Trappiste weapons \
		the sound of firing will be low enough to eradicate the need for ear protection. How safety minded, they even have a non-liability statement too."
...
/obj/structure/sign/poster/official/trappiste_ammunition/examine_more(mob/user)
	...
	. += "Small text details that this information may also be transferrable to other types of SolFed \
		ammunition, but that you should check the box the bullets come in just to be sure. Trappiste is, \
		of course, not liable for excess harm caused by misreading color identification systems."
