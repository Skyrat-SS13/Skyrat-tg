...
/obj/structure/closet/crate/secure/weapon/ww2/PopulateContents()
	. = ..()
	new /obj/item/gun/ballistic/automatic/fg42/modern(src)
	new /obj/item/ammo_box/magazine/fg42(src)
	new /obj/item/gun/ballistic/automatic/akm/modern(src)
	new /obj/item/ammo_box/magazine/akm(src)
	new /obj/item/gun/ballistic/automatic/m16/modern(src)
	new /obj/item/ammo_box/magazine/m16(src)
	new /obj/item/gun/ballistic/automatic/mp40/modern(src)
	new /obj/item/ammo_box/magazine/mp40(src)
	new /obj/item/gun/ballistic/automatic/stg/modern(src)
	new /obj/item/ammo_box/magazine/stg(src)
	new /obj/item/gun/ballistic/automatic/ppsh/modern(src)
	new /obj/item/ammo_box/magazine/ppsh(src)
