/obj/item/gun/ballistic/automatic/submachine_gun/mp40
	name = "\improper MP-40"
	desc = "The instantly recognizable 'axis gun'. Extremely outdated SMG that has only seen service during Sol-3's second World War. This one's a poor, unlicensed reproduction."
