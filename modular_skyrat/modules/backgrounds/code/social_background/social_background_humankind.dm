...
/datum/background_info/social_background/armadyne
	name = "Armadyne"
	description = "Armadyne is one of the largest security and military contractors to date. \
	The leading manufacturer of military grade personal weapons, assault vehicles, defence systems and security measures, \
	Armadyne has a somewhat controversial reputation as a result of blatant war profiteering, compounded by their attempts to \
