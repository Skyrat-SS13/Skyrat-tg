...
/mob/dead/new_player/proc/get_title_html()
	...
	if(SSticker.current_state == GAME_STATE_STARTUP)
      ...
      <a id="story_pref" class="menu_button" href='?src=[text_ref(src)];toggle_story=1'>[client.prefs.read_preference(/datum/preference/toggle/story_pref) ? "<span class='checked'>☑</span> BE STORY PARTICIPANT" : "<span class='unchecked'>☒</span> BE STORY PARTICIPANT"]</a>
			<hr>
