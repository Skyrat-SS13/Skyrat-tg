...
/datum/extension/swing/New(var/atom/user, var/atom/source, var/atom/target, var/angle = 90, var/range = 3, var/duration = 1 SECONDS, var/windup = 0, var/cooldown = 0,  var/effect_type, var/damage = 1, var/damage_flags = 0, var/stages = 8, var/swing_direction = CLOCKWISE)
	.=..()
	if (isliving(user))
		src.user = user
...
/atom/proc/swing_attack(var/swing_type = /datum/extension/swing, var/atom/source, var/atom/target, var/angle = 90, var/range = 3, var/duration = 1 SECONDS, var/windup = 0, var/cooldown = 0,  var/effect_type, var/damage = 1, var/damage_flags = 0, var/stages = 8, var/swing_direction = CLOCKWISE)
