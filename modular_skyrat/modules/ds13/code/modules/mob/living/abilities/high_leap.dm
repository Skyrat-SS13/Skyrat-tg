...
/datum/extension/high_leap
	...
	//Metres per SECONDS, while in the air. Note that this speed is not guaranteed, short-ranged jumps may go slower than this to make the animation look right
	var/travel_speed = 8
...
/datum/extension/high_leap/proc/windup()
	...
	//Alright now SECONDSly, lets look for obstacles that might block us
...
/datum/extension/high_leap/proc/land()
	...
	if (obstacle)
		A.charge_impact(obstacle, 1, CHARGE_TARGET_SECONDSARY, distance)
