/obj/item/gun/magic/hook/contractor
	...
	icon = 'modular_skyrat/modules/antagonists/contractor/icons/hook.dmi'
...
/obj/projectile/hook/contractor
	icon = 'modular_skyrat/modules/antagonists/contractor/icons/hook_projectile.dmi'
	damage = 0
	stamina = 25
	chain_icon = 'modular_skyrat/modules/antagonists/contractor/icons/hook_projectile.dmi'
