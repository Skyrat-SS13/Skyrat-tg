...
GLOBAL_LIST_INIT(spaceshipglass_recipes, list(
	new/datum/stack_recipe("spaceship window", /obj/structure/window/reinforced/shuttle/spaceship/unanchored, 2, time = 4 SECONDS, on_solid_ground = TRUE, check_direction = TRUE, is_fulltile = TRUE), \
	))
