...
/obj/item/keycard/hotelkey1
	name = "Space Hotel Keycard"
	desc = "A keycard with an engraving on it. The engraving reads: \"Guest Room 1\"."
	color = "#ccbe00"
	puzzle_id = "guest_room_1"

/obj/machinery/door/puzzle/keycard/hotelkey1
	name = "Guest Room 1"
	icon = 'modular_skyrat/master_files/icons/obj/structures/puzzle_door.dmi'
	icon_state = "door_closed"
	puzzle_id = "guest_room_1"
	autoclose = 1

/obj/item/keycard/hotelkey2
	name = "Space Hotel Keycard"
	desc = "A keycard with an engraving on it. The engraving reads: \"Guest Room 2\"."
	color = "#ff0066"
	puzzle_id = "guest_room_2"

/obj/machinery/door/puzzle/keycard/hotelkey2
	name = "Guest Room 2"
	icon = 'modular_skyrat/master_files/icons/obj/structures/puzzle_door.dmi'
	icon_state = "door_closed_R2"
	puzzle_id = "guest_room_2"
	autoclose = 1

/obj/item/keycard/hotelkey3
	name = "Space Hotel Keycard"
	desc = "A keycard with an engraving on it. The engraving reads: \"Guest Room 3\"."
	color = "#00FF99"
	puzzle_id = "guest_room_3"

/obj/machinery/door/puzzle/keycard/hotelkey3
	name = "Guest Room 3"
	icon = 'modular_skyrat/master_files/icons/obj/structures/puzzle_door.dmi'
	icon_state = "door_closed_R3"
	puzzle_id = "guest_room_3"
	autoclose = 1

/obj/item/keycard/hotelkey4
	name = "Space Hotel Keycard"
	desc = "A keycard with an engraving on it. The engraving reads: \"Guest Room 4\"."
	color = "#fd8759"
	puzzle_id = "guest_room_4"

/obj/machinery/door/puzzle/keycard/hotelkey4
	name = "Guest Room 4"
	icon = 'modular_skyrat/master_files/icons/obj/structures/puzzle_door.dmi'
	icon_state = "door_closed_R4"
	puzzle_id = "guest_room_4"
	autoclose = 1

/obj/item/keycard/hotelkey5
	name = "Space Hotel Keycard"
	desc = "A keycard with an engraving on it. The engraving reads: \"Guest Room 5\"."
	color = "#15ff00"
	puzzle_id = "guest_room_5"

/obj/machinery/door/puzzle/keycard/hotelkey5
	name = "Guest Room 5"
	icon = 'modular_skyrat/master_files/icons/obj/structures/puzzle_door.dmi'
	icon_state = "door_closed_R5"
	puzzle_id = "guest_room_5"
	autoclose = 1

/obj/item/keycard/hotelkey6
	name = "Space Hotel Keycard"
	desc = "A keycard with an engraving on it. The engraving reads: \"Guest Room 6\"."
	color = "#00a2ff"
	puzzle_id = "guest_room_6"

/obj/machinery/door/puzzle/keycard/hotelkey6
	name = "Guest Room 6"
	icon = 'modular_skyrat/master_files/icons/obj/structures/puzzle_door.dmi'
	icon_state = "door_closed_R6"
	puzzle_id = "guest_room_6"
	autoclose = 1

/obj/item/keycard/hotelkey7
	name = "Space Hotel Keycard"
	desc = "A keycard with an engraving on it. The engraving reads: \"Guest Room 7\"."
	color = "#e3cbff"
	puzzle_id = "guest_room_7"

/obj/machinery/door/puzzle/keycard/hotelkey7
	name = "Guest Room 7"
	icon = 'modular_skyrat/master_files/icons/obj/structures/puzzle_door.dmi'
	icon_state = "door_closed_R7"
	puzzle_id = "guest_room_7"
	autoclose = 1
