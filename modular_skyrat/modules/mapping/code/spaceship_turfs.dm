...
/turf/closed/wall/mineral/titanium/spaceship
	...
	smoothing_groups = SMOOTH_GROUP_WALLS + SMOOTH_GROUP_SHIPWALLS + SMOOTH_GROUP_CLOSED_TURFS
	canSmoothWith = SMOOTH_GROUP_SURVIVAL_TITANIUM_POD + SMOOTH_GROUP_SHIPWALLS + SMOOTH_GROUP_AIRLOCK + SMOOTH_GROUP_SHUTTLE_PARTS
...
/obj/structure/window/reinforced/shuttle/spaceship
	...
	smoothing_flags = SMOOTH_BITMASK
	smoothing_groups = SMOOTH_GROUP_SHIPWALLS + SMOOTH_GROUP_WINDOW_FULLTILE_SHUTTLE + SMOOTH_GROUP_SHUTTLE_PARTS
