...
/obj/effect/mob_spawn/ghost_role/human/tarkon
	...
	flavour_text = "Something went wrong. Morality of experiments went awry, expansions were made before scans were fully done and now you have to deal with the aftermath of your past crews exodus. Bring P-T to the success it was ment to be, or die trying.(OoC note: This ghost role is not designed for plasmamen or vox. While i have made accomodations so they can survive, it should be noted that they were not taken in mind during tarkon's balance and the closet in the middle of the room above is the only consideration i will give, Which is still a bit better than some other ghost roles.)"
