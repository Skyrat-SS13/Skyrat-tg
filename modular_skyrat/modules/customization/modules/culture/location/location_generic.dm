...
/datum/cultural_info/location/mars
	name = "Mars"
	description = "Mars, the current capital of the SolFed, known by its nickname the Red Planet, is one of the most populous centres of Humanity. \
...
/datum/cultural_info/location/venus
	...
	dedicated to providing entertainment, hotels, casinos and various other attractions. Venus is one of the richest planets in the SolFed and \
...
/datum/cultural_info/location/ceres
	...
	Operated primarily by Falco Designs, one of the SolFed's premier shipbuilding corporations, Ceres is home to a multitude of drydocks and service centres \
	...
	employed in shipbuilding, manufacturing, vessel services and hospitality. Belters generally regard themselves as adaptive, proud members of the SolFed \
...
/datum/cultural_info/location/pluto
	...
	to many other planets in the SolFed, with much of it being centred around only two cities, both of which are in desperate need of modernisation \
	...
	of Pluto are, surprisingly, some of the worst off in the SolFed. Downtrodden, poor, and from a locale that is so infested with crime it has become \
...
/datum/cultural_info/location/cetiepsilon
	...
	in the wider SolFed, the planet attracts many to its glittering neon lights and easy to get lost in streets. More importantly, \
	...
	lost.<br><br>The people of Ceti Epsilon are some of the most, well, average in the SolFed. Being from a largely built up world with a focus on \
...
/datum/cultural_info/location/eos
	...
	gateway installation in SolFed space and provides vital links to many other SolFed systems. Practically a city in space unto itself, the HGI is home to a hodgepodge of private individuals, \
	...
	SolFed. This process was hindered during the Gaia conflict, when the Helios Gateway was destroyed in a suicide action of the Fourth Fleet to stop the NRI advance. It has recovered rapidly \
...
/datum/cultural_info/location/tersten
	...
	Tersten is an isolated border world, with little influence in the larger community. Still, it is a proud member of the SolFed, and Tersten City has become a haunt for Third Fleet forces on shore leave. \
...
/datum/cultural_info/location/yuklid
	...
	The Republic of Yuklid is a minor political player within the SolFed, and the Expeditionary Corps use the planet for exoplanet training. It is protected by the Third Fleet. \
