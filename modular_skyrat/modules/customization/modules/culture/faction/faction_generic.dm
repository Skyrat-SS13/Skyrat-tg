...
/datum/cultural_info/faction/solgov
	name = "Sol Federation"
	description = "The Sol Federation, commonly referred to as SolGov or the SolFed, is a federal republic \
	...
	the SolFed governs the majority of human space. Currently engaged in a cold war with the Confederation of Gilgamesh \
	Its primary governing bodies are the Assemblies which are led by an Assembly-elected secretary general. \
	Member states have a great degree of freedom in their actions, though the SolFed manages sapient rights, \
	domestic security, economic policy, and diplomacy for humanity as a whole. The SolFed's population is diverse \
...
/datum/cultural_info/faction/freetrade
	...
	various traders and merchants from all over SolFed space and beyond. Colloquially known as the 'fifth megacorp', they control a sizeable fleet \
...
/datum/cultural_info/faction/fleet
	name = "SolFed Fleet"
	description = "The Fleet is the primary component of the SolFed Defence Forces. It mostly protects SolFed space from pirates, smugglers, \
	...
	Any SolFed human citizen with at least a secondary school level of education can enlist into the Fleet, going through \
...
/datum/cultural_info/faction/torchco
	...
	protocols, and xenoartifacts being 'lost' in transit, but nothing has been conclusively proven as of yet, and SolFed doubtless is \
...
/datum/cultural_info/faction/police
	...
	description = "The Sol Federal (SFP) is a government law enforcement agency tasked with enforcing Sol Federation law, \
...
/datum/cultural_info/faction/dais
	...
	Government, its systems used by most consumers and businesses within SolGov. DAIS is actually older than the Sol Federation and is one of the very \
...
/datum/cultural_info/faction/nri_industries
	name = "Novaya Rossiyskaya Imperiya Industrial and Colonial Development Collegium"
	description = "The \"New Russian Empire\", commonly referred to as the Novaya Rossiyskaya Imperiya (NRI), is a regional power in human space,\
	bordered by the Sol Federation towards the galactic centre. The capital of the Empire is the city of New Saint Petersburg on the planet of Providence \
	in the Ararat system. Externally heavily militant and isolationist, the NRI, internally, is heavily democratical, with \
	a strong focus on independent regional government with the NRI itself only handling defence, foreign relations and some intergalactic trade. \
