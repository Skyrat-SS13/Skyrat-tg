...
/datum/cultural_info/faction/nri/police_military
	name = "NRI, Defense and Peacekeeping Collegium"
	...
	<br> \
	Imperial Defense Collegia is a state military force mainly consisting ground troops and mechanised infantry of the empire, being the second largest human military currently known. \
	...
	Their military consists of the Naval branch; Infantry and Armored Divisions; Border Patrol and Marine Corps; Space Aviation and Troops, all of them under control of the Admiralty of different branches. \
	<br> \
...
/datum/cultural_info/faction/nri/healthcare_science
	name = "NRI, Healthcare and Innovations Collegium"
...
/datum/cultural_info/faction/nri/industries
	name = "NRI, Industrial and Colonial Development Collegium"
...
/datum/cultural_info/faction/nri/bureaucrat
	name = "NRI, External Relationships and Cultural Collegium"
	description = "External Relationships Collegia is the governmental organisation comprised of a great assortment of various diplomats, senators and councilors that organise and keep the giant imperial bureaucratic machine going and moreover, make sure it stays in good relations with other governments. \
	Being practically THE government when it comes to public relations, with its affiliations to the Empress and higher royalty being incredibly close, on paper ERC has the most power of all collegias, organising treaties, creating trade agreements and declaring wars if needed. \
	Cultural Collegia is the governmental organisation that manages the empire's education, cultural preservation and the statistics regarding the population. Being probably the least memorable collegia due to its incredibly niche functionality, which results in not the highest budget allocation, it rarely receives any spotlight nor has that much professionals to begin with."
