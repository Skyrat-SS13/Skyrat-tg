...
/datum/cultural_info/culture/generic_human
	...
	additional_langs = list(/datum/language/panslavic, /datum/language/gutter, /datum/language/spacer, /datum/language/yangyu, /datum/language/selenian, /datum/language/xerxian)
