...
/obj/item/clothing/glasses/hud/eyepatch/meson/blindfold
	...
	desc = "A fake blindfold with a meson scanner inside. Doesn't shield against welding."
...
/obj/item/clothing/glasses/hud/eyepatch/sci/blindfold
	...
	desc = "A fake blindfold with a science HUD inside, provides a way to get used to blindfolds before you inevitably end up needing the real thing."
	icon_state = "scifold"
