/obj/item/clothing/under/bodysash
	...
	icon = 'modular_skyrat/master_files/icons/obj/clothing/sashes.dmi' // item icon
	worn_icon =  'modular_skyrat/master_files/icons/obj/clothing/sashes_worn.dmi' // mob worn icon
	icon_state = "assistant" // Inventory Icon
	body_parts_covered = CHEST // |GROIN|ARMS
	lefthand_file = 'modular_skyrat/master_files/icons/obj/clothing/sashes_hold_left.dmi'
	righthand_file = 'modular_skyrat/master_files/icons/obj/clothing/sashes_hold_right.dmi'
