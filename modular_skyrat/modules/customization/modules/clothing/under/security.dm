...
/obj/item/clothing/under/rank/security/blackwatch
	...
	icon = 'modular_skyrat/modules/customization/icons/obj/clothing/under/uniform.dmi'
	worn_icon = 'modular_skyrat/modules/customization/icons/mob/clothing/under/uniforms.dmi'
