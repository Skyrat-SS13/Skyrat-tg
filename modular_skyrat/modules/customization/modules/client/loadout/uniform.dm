...
/datum/loadout_item/uniform/job/secskirt
	...
	restricted_roles = list("Security Officer", "Warden","Security Sergeant", "Head of Security")
...
/datum/loadout_item/uniform/job/utility_sec
	...
	restricted_roles = list("Security Officer", "Detective", "Warden", "Blueshield", "Security Sergeant", "Security Medic", "Head of Security")
...
/datum/loadout_item/uniform/job/trek/trekmedscitos
	...
	restricted_roles = list("Chief Medical Officer","Medical Doctor","Chemist","Virologist","Geneticist", "Security Medic", "Research Director","Scientist", "Roboticist")

/datum/loadout_item/uniform/job/trek/trekengtos
	name = "TOS - ops/sec"
	path = /obj/item/clothing/under/trek/engsec
	restricted_desc = "Engineering, Security, and Cargo"
	restricted_roles = list("Chief Engineer","Atmospheric Technician","Station Engineer","Warden", "Security Medic", "Detective","Security Officer","Security Sergeant","Head of Security","Cargo Technician", "Shaft Miner", "Quartermaster")
...
/datum/loadout_item/uniform/job/trekengtng
	...
	restricted_desc = "Engineering, Security, and Cargo"
	restricted_roles = list("Chief Engineer","Atmospheric Technician","Station Engineer","Security Medic","Warden","Detective","Security Officer","Security Sergeant","Head of Security","Cargo Technician", "Shaft Miner", "Quartermaster")
...
/datum/loadout_item/uniform/job/trekmedscient
	...
	restricted_desc = "Medical and Science"
	restricted_roles = list("Chief Medical Officer","Medical Doctor","Paramedic","Chemist","Security Medic","Virologist","Geneticist","Research Director","Scientist", "Roboticist")
