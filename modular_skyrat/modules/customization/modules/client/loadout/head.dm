...
/datum/loadout_item/head/trek/trekcapeng
	...
	restricted_roles = list("Chief Engineer","Atmospheric Technician","Station Engineer","Warden","Detective","Security Officer","Security Medic", "Security Sergeant","Head of Security","Cargo Technician", "Shaft Miner", "Quartermaster")
...
/datum/loadout_item/head/job/cowboyhat/sec
	...
	restricted_roles = list("Warden","Detective","Security Officer","Security Medic", "Security Sergeant","Head of Security")
