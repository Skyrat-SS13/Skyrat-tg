/datum/species/mammal
	...
	default_mutant_bodyparts = list("tail" = ACC_RANDOM, "snout" = ACC_RANDOM, "horns" = "None", "ears" = ACC_RANDOM, "legs" = ACC_RANDOM, "taur" = "None", "wings" = "None", "head_acc" = "None", "neck_acc" = "None")
	attack_verb = "slash"
