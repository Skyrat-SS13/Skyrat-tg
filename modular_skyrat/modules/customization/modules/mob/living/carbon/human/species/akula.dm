...
/datum/species/akula/get_species_description()
	return {"The Azuleans, also widely known as Akula, are one of several sapient species of humanoids and make up one of four primary \"nations\" in current-day charted space. \
	Their physiology is closely shark-like, yet posesses mammalian features that allow them to exist in both water and land without complication. \
