/datum/species/tajaran
	...
	cultures = list(CULTURES_EXOTIC,CULTURES_HUMAN,CULTURE_TAJARAN)
	learnable_languages = list(/datum/language/common,/datum/language/tajaran,/datum/language/tajaran/uncommon)
