...
/datum/sprite_accessory
	 ...
	 * Valid extras are: `SPRITE_ACCESSORY_MAIN`, `SPRITE_ACCESSORY_EXTRA2`, `SPRITE_ACCESSORY_INNER`, and if you're using matrixed, just use the name of your color layer.
	 ...
	 * OR, if you don't want a certain sprite extra to render on certain layers (e.g, you don't want inner to render on the behind layer): `list(BODY_FRONT_LAYER, BODY_BEHIND_LAYER = list(SPRITE_ACCESSORY_MAIN))`
	 */
