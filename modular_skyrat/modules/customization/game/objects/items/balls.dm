/obj/item/toy/tennis
	...
	icon = 'modular_skyrat/icons/obj/balls.dmi'
	icon_state = "tennis_classic"
	lefthand_file = 'modular_skyrat/icons/mob/inhands/balls_left.dmi'
	righthand_file = 'modular_skyrat/icons/mob/inhands/balls_right.dmi'
	inhand_icon_state = "tennis_classic"
	worn_icon = 'modular_skyrat/icons/mob/mouthball.dmi'
