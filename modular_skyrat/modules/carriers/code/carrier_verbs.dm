...
/mob/living/proc/carrier_say()
	...
	var/datum/component/carrier/target_soulcatcher = get_current_carrier_room()
	...
	room_to_send_to.send_message(message_to_send, target_soulcatcher.targeted_carrier_room.outside_voice)
	return TRUE
...
/mob/living/proc/carrier_emote()
	...
	room_to_send_to.send_message(message_to_send, target_soulcatcher.targeted_carrier_room.outside_voice, TRUE)
	return TRUE
...
/mob/living/proc/get_current_carrier_room()
	...
	var/atom/current_holder = master_carrier.parent
	if(!current_holder.HasProximity(src))
