...
/obj/machinery/vending/access/command/build_access_list(list/access_lists)
	...
	access_lists["[ACCESS_RD]"] = list(
		/obj/item/clothing/head/beret/science/fancy/rd = 1, /obj/item/clothing/head/beret/science/fancy/rd/alt = 1,
	...
	access_lists["[ACCESS_HOS]"] = list(
		...
		/obj/item/clothing/under/rank/security/head_of_security/peacekeeper = 1, /obj/item/clothing/under/rank/security/head_of_security/peacekeeper/sol = 1,
	...
	access_lists["[ACCESS_CENT_GENERAL]"] = list( // CC Rep Shiz
		/obj/item/clothing/head/nanotrasen_representative = 1, /obj/item/clothing/head/nanotrasen_representative/beret = 1,
		/obj/item/clothing/head/beret/centcom_formal/ntrep = 1, /obj/item/clothing/under/rank/nanotrasen_representative = 1,
		/obj/item/clothing/under/rank/nanotrasen_representative/skirt = 1, /obj/item/clothing/head/centhat = 1,
		/obj/item/clothing/head/centcom_cap = 1, /obj/item/clothing/suit/toggle/armor/vest/centcom_formal/ntrep = 1,
		)
