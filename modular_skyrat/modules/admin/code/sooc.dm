...
/client/verb/sooc(msg as text)
	...
	var/static/list/job_lookup = list(JOB_CAPTAIN=TRUE, JOB_HEAD_OF_SECURITY=TRUE, JOB_WARDEN=TRUE, JOB_DETECTIVE=TRUE, JOB_SECURITY_OFFICER=TRUE, JOB_SECURITY_OFFICER_MEDICAL=TRUE, JOB_SECURITY_OFFICER_ENGINEERING=TRUE, JOB_SECURITY_OFFICER_SCIENCE=TRUE, JOB_SECURITY_OFFICER_SUPPLY=TRUE, JOB_CORRECTIONS_OFFICER=TRUE, JOB_SECURITY_MEDIC=TRUE, JOB_SECURITY_SERGEANT=TRUE, JOB_CIVIL_DISPUTES_OFFICER=TRUE, JOB_BLUESHIELD=TRUE)
	if(!holder)
