...
GLOBAL_LIST_INIT(oddity_loot, list(//oddity: strange or crazy items
	...
	/obj/item/reagent_containers/food/drinks/bottle/holywater/hell = 25,
	/obj/item/relic = 200,
