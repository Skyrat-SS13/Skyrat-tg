...
/datum/wound/synthetic/pierce/moderate
	...
	treat_text = "Treat affected site with bandaging to help stem the flow before welding and taping." // space is cold in ss13, so it's like an ice pack!
	examine_desc = "has a small, circular hole piercing a vital line, hydraulic fluid slowly leaking out"
...
/datum/wound/synthetic/pierce/severe
	...
	treat_text = "Repair punctures in hydraulic lines through welding. Exposure to extreme cold may work in a pinch."
	examine_desc = "is pierced clear through, bits of mangled metal obscuring the open hole"
	occur_text = "looses a violent spray of oil, a clear hole being revealed"
...
/datum/wound/synthetic/pierce/critical
	...
	desc = "Patient's internal structure has been heavily compromised causing massive hydraulic fluid loss."
	treat_text = "Heavy welding and potential mechanical intervention required to ensure limb operability"
	examine_desc = "is torn through almost in twain, leaking oil and shuddering violently"
	occur_text = "blasts apart, chunks of shrapnel flying in all directions"
