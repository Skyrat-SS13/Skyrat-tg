...
/datum/design/microfusion/cell/advanced
	...
	materials =  list(
		/datum/material/iron = 1000,
		/datum/material/gold = 300,
		/datum/material/silver = 300,
		/datum/material/glass = 300,
		/datum/material/uranium = 300,
	)
...
/datum/design/microfusion/cell/bluespace
	...
	materials = list(
		...
		/datum/material/gold = 300,
		/datum/material/glass = 300,
		/datum/material/diamond = 300,
		/datum/material/uranium = 300,
		/datum/material/titanium = 300,
		/datum/material/bluespace = 300,
	)
...
/datum/design/microfusion/cell_attachment_selfcharging
	...
	) // Makes it almost in-line with Advanced Egun pricing
