...
/datum/pollution/proc/get_overlay(list/pollutant_list, total_amount)
	...
	var/mutable_appearance/overlay = mutable_appearance('icons/effects/96x96.dmi', "smoke", FLY_LAYER, RENDER_PLANE_GAME_WORLD, appearance_flags = KEEP_APART|RESET_TRANSFORM|RESET_COLOR)
	overlay.pixel_x = -32
	overlay.pixel_y = -32
