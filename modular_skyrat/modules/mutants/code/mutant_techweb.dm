...
/datum/design/rna_vial
	...
	materials = list(/datum/material/iron = 1000, /datum/material/glass = 3000, /datum/material/silver = HALF_SHEET_MATERIAL_AMOUNT)
...
/datum/design/rna_extractor
	...
	id = "rna_extractor"
	build_type = PROTOLATHE
	materials = list(/datum/material/iron = SHEET_MATERIAL_AMOUNT * 2, /datum/material/gold = 3000, /datum/material/uranium = 1000, /datum/material/diamond = 1000)
