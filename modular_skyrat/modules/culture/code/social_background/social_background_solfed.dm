/datum/background_info/social_background/solfed
	name = "Sol Federation"
	description = "The Sol Federation, commonly referred to as SolFed, is a federal republic \
	composed of numerous human member states spanning many systems.\
	Based in the Sol System, the Sol Federation governs the majority of human space. \
	They are currently engaged in a three-way cold war with the Taj Empire and Agurkrral. \
	Member states have a great degree of freedom in their actions, though the SolFed manages sapient rights, \
	domestic security, economic policy, and diplomacy for humanity as a whole. \
	The SolFed's population is diverse, including many non-humans (though they are not citizens) and encompassing a wide range of systems, \
...
/datum/background_info/social_background/solfed/police
