...
/turf/open/floor/iron/elevated
	...
	smoothing_groups = SMOOTH_GROUP_ELEVATED_PLASTEEL + SMOOTH_GROUP_WALLS + SMOOTH_GROUP_CLOSED_TURFS
	canSmoothWith = SMOOTH_GROUP_ELEVATED_PLASTEEL + SMOOTH_GROUP_WALLS
	liquid_height = 30
	turf_height = 30
...
/turf/open/floor/iron/lowered
	...
	smoothing_flags = SMOOTH_BITMASK
	smoothing_groups = SMOOTH_GROUP_LOWERED_PLASTEEL + SMOOTH_GROUP_WALLS + SMOOTH_GROUP_CLOSED_TURFS
	canSmoothWith = SMOOTH_GROUP_LOWERED_PLASTEEL + SMOOTH_GROUP_WALLS
	liquid_height = -30
	turf_height = -30
