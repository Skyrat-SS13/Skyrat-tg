#define SUPERMATTER_SURGE_BULLET_ENERGY_FACTOR_UPPER 14
#define SUPERMATTER_SURGE_BULLET_ENERGY_FACTOR_LOWER 6
#define SUPERMATTER_SURGE_TIME_UPPER 5 MINUTES
#define SUPERMATTER_SURGE_TIME_LOWER 2 MINUTES
#define SUPERMATTER_SURGE_ANNOUNCE_THRESHOLD 8
