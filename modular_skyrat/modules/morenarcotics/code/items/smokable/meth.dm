...
/obj/item/smokable/blue_sky
	...
	smokable_reagent = /datum/reagent/drug/blue_sky/crystal
	reagent_amount = 10

/obj/item/smokable/blue_sky/proc/update_icon_purity(purity)
...
/datum/export/blue_sky
	cost = CARGO_CRATE_VALUE * 0.6
	unit_name = "crack"
	export_types = list(/obj/item/smokable/blue_sky)
	include_subtypes = FALSE
