...
/obj/item/food/drug/smarts/block/MakeProcessable()
	AddElement(/datum/element/processable, TOOL_KNIFE, /obj/item/food/drug/smarts, amount_created = 4, time_to_process = 3 SECONDS, table_required = TRUE, screentip_verb = "Slice")
	AddElement(/datum/element/processable, TOOL_SAW, /obj/item/food/drug/smarts, amount_created = 4, time_to_process = 4 SECONDS, table_required = TRUE, screentip_verb = "Slice")
