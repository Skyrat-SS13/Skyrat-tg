...
/obj/item/robot_model/service
	...
	borg_skins = list(
		...
		"Meka" = list(SKIN_ICON_STATE = "mekaserve", SKIN_ICON = CYBORG_ICON_SERVICE_TALL, SKIN_FEATURES = list(R_TRAIT_UNIQUEWRECK, R_TRAIT_TALL), SKIN_HAT_OFFSET = 16),
...
/obj/item/robot_model/janitor
	borg_skins = list(
		...
		"Meka" = list(SKIN_ICON_STATE = "mekajani", SKIN_ICON = CYBORG_ICON_JANI_TALL, SKIN_FEATURES = list(R_TRAIT_UNIQUEWRECK, R_TRAIT_TALL), SKIN_HAT_OFFSET = 16),
...
/obj/item/robot_model/medical
	borg_skins = list(
		...
		"Meka" = list(SKIN_ICON_STATE = "mekamed", SKIN_ICON = CYBORG_ICON_MED_TALL, SKIN_FEATURES = list(R_TRAIT_UNIQUEWRECK, R_TRAIT_TALL), SKIN_HAT_OFFSET = 16),
...
/obj/item/robot_model/peacekeeper
	borg_skins = list(
		...
		"Meka" = list(SKIN_ICON_STATE = "mekapeace", SKIN_ICON = CYBORG_ICON_PEACEKEEPER_TALL, SKIN_FEATURES = list(R_TRAIT_UNIQUEWRECK, R_TRAIT_TALL), SKIN_HAT_OFFSET = 16),
...
/obj/item/robot_model/syndicatejack
	...
	borg_skins = list(
		...
		"Meka" = list(SKIN_ICON_STATE = "mekasyndi", SKIN_ICON = CYBORG_ICON_SYNDIE_TALL, SKIN_FEATURES = list(R_TRAIT_UNIQUEWRECK, R_TRAIT_TALL), SKIN_HAT_OFFSET = 16),
...
/obj/item/robot_model/ninja
	...
	borg_skins = list(
		...
		"Meka" = list(SKIN_ICON_STATE = "mekaninja", SKIN_ICON = CYBORG_ICON_NINJA_TALL, SKIN_FEATURES = list(R_TRAIT_UNIQUEWRECK, R_TRAIT_TALL), SKIN_HAT_OFFSET = 16),
