...
/obj/item/robot_model/service
	...
	borg_skins = list(
		...
		"Meka (Alt)" = list(SKIN_ICON_STATE = "mekaserve_alt", SKIN_ICON = CYBORG_ICON_SERVICE_TALL, SKIN_FEATURES = list(R_TRAIT_UNIQUEWRECK, R_TRAIT_UNIQUETIP, R_TRAIT_TALL), SKIN_HAT_OFFSET = 15),
