...
/obj/item/robot_model/service
	...
	borg_skins = list(
		...
		"Vix" = list(SKIN_ICON_STATE = "vixserv", SKIN_LIGHT_KEY = "eyes-vixserv", SKIN_ICON = CYBORG_ICON_SERVICE_WIDE, SKIN_FEATURES = list(R_TRAIT_UNIQUEWRECK, R_TRAIT_WIDE))
	)
...
/obj/item/robot_model/miner
	...
	borg_skins = list(
		...
		"Vix" = list(SKIN_ICON_STATE = "vixmine", SKIN_LIGHT_KEY = "eyes-vixmine", SKIN_ICON = CYBORG_ICON_MINING_WIDE, SKIN_FEATURES = list(R_TRAIT_UNIQUEWRECK, R_TRAIT_WIDE))
	)
...
/obj/item/robot_model/engineering
	borg_skins = list(
		...
		"Vix" = list(SKIN_ICON_STATE = "vixengi", SKIN_LIGHT_KEY = "eyes-vixengi", SKIN_ICON = CYBORG_ICON_ENG_WIDE, SKIN_FEATURES = list(R_TRAIT_UNIQUEWRECK, R_TRAIT_WIDE))
	)
...
/obj/item/robot_model/janitor
	borg_skins = list(
		...
		"Vix" = list(SKIN_ICON_STATE = "vixjani", SKIN_LIGHT_KEY = "eyes-vixjani", SKIN_ICON = CYBORG_ICON_JANI_WIDE, SKIN_FEATURES = list(R_TRAIT_UNIQUEWRECK, R_TRAIT_WIDE))
	)
...
/obj/item/robot_model/medical
	borg_skins = list(
		...
		"Vix" = list(SKIN_ICON = CYBORG_ICON_MED_WIDE, SKIN_ICON_STATE = "vixmed", SKIN_LIGHT_KEY = "eyes-vixmed" , SKIN_FEATURES = list(R_TRAIT_UNIQUEWRECK, R_TRAIT_WIDE))
	)
...
/obj/item/robot_model/peacekeeper
	borg_skins = list(
		...
		"Vix" = list(SKIN_ICON_STATE = "vixpk", SKIN_LIGHT_KEY = "eyes-vixpk", SKIN_ICON = CYBORG_ICON_PEACEKEEPER_WIDE, SKIN_FEATURES = list(R_TRAIT_UNIQUEWRECK, R_TRAIT_WIDE))
	)
...
/obj/item/robot_model/security
	borg_skins = list(
		...
		"Vix" = list(SKIN_ICON_STATE = "vixsec", SKIN_LIGHT_KEY = "eyes-vixsec", SKIN_ICON = CYBORG_ICON_SEC_WIDE, SKIN_FEATURES = list(R_TRAIT_UNIQUEWRECK, R_TRAIT_WIDE))
	)
