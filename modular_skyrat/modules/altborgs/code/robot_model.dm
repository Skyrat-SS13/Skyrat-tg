...
/obj/item/robot_model/service
	...
	//	"Meka" = list(SKIN_ICON_STATE = "mekaserve", SKIN_ICON = CYBORG_ICON_SERVICE_TALL, SKIN_FEATURES = list(R_TRAIT_UNIQUEWRECK, R_TRAIT_TALL), SKIN_HAT_OFFSET = 17),
...
/obj/item/robot_model/janitor
	...
	//	"Meka" = list(SKIN_ICON_STATE = "mekajani", SKIN_ICON = CYBORG_ICON_JANI_TALL, SKIN_FEATURES = list(R_TRAIT_UNIQUEWRECK, R_TRAIT_TALL), SKIN_HAT_OFFSET = 17),
...
/obj/item/robot_model/medical
	...
	//	"Meka" = list(SKIN_ICON_STATE = "mekamed", SKIN_ICON = CYBORG_ICON_MED_TALL, SKIN_FEATURES = list(R_TRAIT_UNIQUEWRECK, R_TRAIT_TALL), SKIN_HAT_OFFSET = 17),
...
/obj/item/robot_model/peacekeeper
	...
	//	"Meka" = list(SKIN_ICON_STATE = "mekapeace", SKIN_ICON = CYBORG_ICON_PEACEKEEPER_TALL, SKIN_FEATURES = list(R_TRAIT_UNIQUEWRECK, R_TRAIT_TALL), SKIN_HAT_OFFSET = 17),
...
/obj/item/robot_model/syndicatejack
	...
	//	"Meka" = list(SKIN_ICON_STATE = "mekasyndi", SKIN_ICON = CYBORG_ICON_SYNDIE_TALL, SKIN_FEATURES = list(R_TRAIT_UNIQUEWRECK, R_TRAIT_TALL), SKIN_HAT_OFFSET = 17),
...
/obj/item/robot_model/ninja
	...
	//	"Meka" = list(SKIN_ICON_STATE = "mekaninja", SKIN_ICON = CYBORG_ICON_NINJA_TALL, SKIN_FEATURES = list(R_TRAIT_UNIQUEWRECK, R_TRAIT_TALL), SKIN_HAT_OFFSET = 17),
