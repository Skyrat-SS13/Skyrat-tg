...
/datum/outfit/job/blueshield
	...
	suit_store = /obj/item/gun/ballistic/automatic/cfa_wildcat
	...
	backpack_contents = list(/obj/item/ammo_box/magazine/smg32 = 2,/obj/item/melee/baton/blueshieldprod = 1)
