...
/obj/item/bodypart/head/monkey/mauler
	icon = 'modular_skyrat/modules/fleshmind/icons/mauler_monkey_parts.dmi'
	icon_greyscale = 'modular_skyrat/modules/fleshmind/icons/mauler_monkey_parts.dmi'
	icon_static = 'modular_skyrat/modules/fleshmind/icons/mauler_monkey_parts.dmi'
