/datum/design/cyberimp_mantis
	...
	category = list(RND_CATEGORY_CYBERNETICS + RND_SUBCATEGORY_CYBERNETICS_IMPLANTS_COMBAT)
...
/datum/design/cyberimp_hacker
	...
	category = list(RND_CATEGORY_CYBERNETICS + RND_SUBCATEGORY_CYBERNETICS_IMPLANTS_UTILITY)
...
/datum/design/cyberimp_scanner
	...
	category = list(RND_CATEGORY_CYBERNETICS + RND_SUBCATEGORY_CYBERNETICS_IMPLANTS_HEALTH)
	departmental_flags = DEPARTMENT_BITFLAG_MEDICAL
