...
/datum/sprite_accessory/proc/lewd_is_hidden(mob/living/carbon/human/target_human, hide_if_catsuit = TRUE, hide_if_sleeping_bag = TRUE)
	if(target_human.wear_suit && istype(target_human.wear_suit, /obj/item/clothing/suit/jacket/straight_jacket/sleeping_bag))
		var/obj/item/clothing/suit/jacket/straight_jacket/sleeping_bag/sleeping_bag = target_human.wear_suit
		if(sleeping_bag.inflated)
