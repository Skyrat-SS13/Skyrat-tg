...
/obj/item/reagent_containers/glass/lewd_filter
	...
	list_reagents = list(/datum/reagent/drug/aphrodisiac/crocin = 50) //You can make it strating empty, but i'm pretty sure 90% of players will use just aphrodisiacs, so why just don't make their life easier?
