...
/obj/item/clothing/glasses/blindfold/kinky/equipped(mob/user, slot)
	...
	if(src == C.glasses)
		to_chat(C, "<font color=purple>The blindfold blocks your vision! You can't make out anything on the other side...</font>")
	else
		return
...
/obj/item/clothing/glasses/blindfold/kinky/dropped(mob/user)
	...
	var/mob/living/carbon/C = user
	if(src == C.glasses)
		to_chat(C, "<font color=purple>The blindfold no longer restricts your vision.</font>")
