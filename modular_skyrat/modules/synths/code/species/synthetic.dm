...
/datum/species/synthetic/create_pref_unique_perks()
	...
	to_add += list(list( //tryin to keep traits minimal since synths will get a lot of traits when my upstream traits pr is merged
		SPECIES_PERK_TYPE = SPECIES_POSITIVE_PERK,
		SPECIES_PERK_ICON = "robot",
		SPECIES_PERK_NAME = "Synthetic Benefits",
		SPECIES_PERK_DESC = "Unlike organics, you DON'T explode when faced with vaccum! Additionally, your chassis is built with such strength as to \
	...
	to_add += list(list(
		...
		wire from your arm to draw power from an APC. Atop this, Welders and wires are your sutures and mesh, and you are immune to the metabolization effects of all chemicals - a blessing \
