...
/datum/wound/synthetic/muscle/proc/attack_with_hurt_hand(mob/M, atom/target, proximity)
	...
	if(prob(severity * 15))
		...
		if(prob(70 - 20 * severity))
			to_chat(victim, "<span class='userdanger'>The control circuits in your [limb.name] malfunctions as you strike [target]; arcing violently!</span>")
			...
			"<span class='userdanger'>You fail to strike [target] as the fractured hydraulics in your [limb.name] lights up with multiple warnings; your internals failing!</span>", vision_distance=COMBAT_MESSAGE_RANGE)
...
/datum/wound/synthetic/muscle/moderate
	...
	examine_desc = "appears to have been damaged, hydraulics leaking fluid"
	occur_text = "sparks, and begins leaking oil"
