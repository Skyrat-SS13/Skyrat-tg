/datum/armament_entry/cargo_gun/kahraman
...
/datum/armament_entry/cargo_gun/blacksteel/ppe/sensors_cuffs
...
/datum/armament_entry/cargo_gun/blacksteel/mining_tool
	subcategory = "Powered Mining Equipment"

/datum/armament_entry/cargo_gun/blacksteel/mining_tool/drill
	item_type = /obj/item/pickaxe/drill
	lower_cost = CARGO_CRATE_VALUE * 0.75
	upper_cost = CARGO_CRATE_VALUE * 1.5

/datum/armament_entry/cargo_gun/blacksteel/mining_tool/resonator
	item_type = /obj/item/resonator
	lower_cost = CARGO_CRATE_VALUE
	upper_cost = CARGO_CRATE_VALUE * 2

/datum/armament_entry/cargo_gun/blacksteel/mining_tool/pka
	item_type = /obj/item/gun/energy/recharge/kinetic_accelerator
	lower_cost = CARGO_CRATE_VALUE
	upper_cost = CARGO_CRATE_VALUE * 2

/datum/armament_entry/cargo_gun/blacksteel/mining_tool/cutter
...
/datum/armament_entry/cargo_gun/blacksteel/mining_tool/diamond_drill
	item_type = /obj/item/pickaxe/drill/diamonddrill
	lower_cost = CARGO_CRATE_VALUE
	upper_cost = CARGO_CRATE_VALUE * 2
	interest_required = PASSED_INTEREST

/datum/armament_entry/cargo_gun/blacksteel/mining_tool/advanced_cutter
	item_type = /obj/item/gun/energy/plasmacutter/adv
	lower_cost = CARGO_CRATE_VALUE * 1.5
	upper_cost = CARGO_CRATE_VALUE * 3
	interest_required = PASSED_INTEREST

/datum/armament_entry/cargo_gun/blacksteel/mining_tool/super_resonator
	item_type = /obj/item/resonator/upgraded
	lower_cost = CARGO_CRATE_VALUE * 1.5
	upper_cost = CARGO_CRATE_VALUE * 3
	interest_required = PASSED_INTEREST

/datum/armament_entry/cargo_gun/blacksteel/mining_tool/jackhammer
	item_type = /obj/item/pickaxe/drill/jackhammer
	lower_cost = CARGO_CRATE_VALUE * 1.5
	upper_cost = CARGO_CRATE_VALUE * 3
	interest_required = PASSED_INTEREST

/datum/armament_entry/cargo_gun/blacksteel/sensing
	subcategory = "Sensing Equipment"

/datum/armament_entry/cargo_gun/blacksteel/sensing/mesons
	item_type = /obj/item/clothing/glasses/meson
	lower_cost = CARGO_CRATE_VALUE * 0.2
	upper_cost = CARGO_CRATE_VALUE * 0.5

/datum/armament_entry/cargo_gun/blacksteel/sensing/autoscanner
	item_type = /obj/item/t_scanner/adv_mining_scanner/lesser
	lower_cost = CARGO_CRATE_VALUE * 0.4
	upper_cost = CARGO_CRATE_VALUE

/datum/armament_entry/cargo_gun/blacksteel/sensing/super_autoscanner
	item_type = /obj/item/t_scanner/adv_mining_scanner
	lower_cost = CARGO_CRATE_VALUE * 0.7
	upper_cost = CARGO_CRATE_VALUE * 1.3
	interest_required = PASSED_INTEREST

/datum/armament_entry/cargo_gun/blacksteel/sensing/nvg_mesons
	item_type = /obj/item/clothing/glasses/meson/night
	lower_cost = CARGO_CRATE_VALUE
	upper_cost = CARGO_CRATE_VALUE * 1.5
	interest_required = PASSED_INTEREST

/datum/armament_entry/cargo_gun/blacksteel/mecha_tools
	subcategory = "Heavy Powered Mining Equipment"

/datum/armament_entry/cargo_gun/blacksteel/mecha_tools/scanner
	item_type = /obj/item/mecha_parts/mecha_equipment/mining_scanner
	lower_cost = CARGO_CRATE_VALUE * 0.5
	upper_cost = CARGO_CRATE_VALUE

/datum/armament_entry/cargo_gun/blacksteel/mecha_tools/drill
	item_type = /obj/item/mecha_parts/mecha_equipment/drill
	lower_cost = CARGO_CRATE_VALUE
	upper_cost = CARGO_CRATE_VALUE * 1.5

/datum/armament_entry/cargo_gun/blacksteel/mecha_tools/pka
...
/datum/armament_entry/cargo_gun/blacksteel/mecha_tools/diamond_drill
	item_type = /obj/item/mecha_parts/mecha_equipment/drill/diamonddrill
	lower_cost = CARGO_CRATE_VALUE * 2
	upper_cost = CARGO_CRATE_VALUE * 3
	interest_required = PASSED_INTEREST

/datum/armament_entry/cargo_gun/blacksteel/mecha_tools/cutter
