#define PRICE_FIRST_AID_BASIC_LOWER 8
#define PRICE_FIRST_AID_BASIC_HIGHER 6
#define PRICE_FIRST_AID_MEDIUM_LOWER 6
#define PRICE_FIRST_AID_MEDIUM_HIGHER 5
#define PRICE_FIRST_AID_PREMIUM_LOWER 4
#define PRICE_FIRST_AID_PREMIUM_HIGHER 3
