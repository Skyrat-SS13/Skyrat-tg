/datum/armament_entry/cargo_gun/nanotrasen_bolt_weapons
	category = BOLT_NANOTRASEN_DEFENSE_NAME
	company_bitflag = CARGO_COMPANY_BOLT_NANOTRASEN

// Basic armor vests

/datum/armament_entry/cargo_gun/nanotrasen_bolt_weapons/armor
	subcategory = "Light Body Armor"

/datum/armament_entry/cargo_gun/nanotrasen_bolt_weapons/armor/slim_vest
...
/datum/armament_entry/cargo_gun/nanotrasen_bolt_weapons/armor/normal_vest
...
/datum/armament_entry/cargo_gun/nanotrasen_bolt_weapons/nonlethal
	subcategory = "Non-Lethal Weapons"
	interest_addition = COMPANY_INTEREST_GAIN_AVERAGE

/datum/armament_entry/cargo_gun/nanotrasen_bolt_weapons/nonlethal/responder
	item_type = /obj/item/gun/energy/disabler/bolt_disabler
	lower_cost = CARGO_CRATE_VALUE * 2
	upper_cost = CARGO_CRATE_VALUE * 4
	stock_mult = 2

/datum/armament_entry/cargo_gun/nanotrasen_bolt_weapons/nonlethal/pepperball
...
/datum/armament_entry/cargo_gun/nanotrasen_bolt_weapons/lethal_sidearm
	subcategory = "Lethal Sidearms"
	interest_addition = COMPANY_INTEREST_GAIN_BIG
	interest_required = PASSED_INTEREST

/datum/armament_entry/cargo_gun/nanotrasen_bolt_weapons/lethal_sidearm/detective_revolver
...
/datum/armament_entry/cargo_gun/nanotrasen_bolt_weapons/longarm
...
/datum/armament_entry/cargo_gun/nanotrasen_bolt_weapons/longarm/wt550
	item_type = /obj/item/gun/ballistic/automatic/wt550
	lower_cost = CARGO_CRATE_VALUE * 10
	upper_cost = CARGO_CRATE_VALUE * 15

/datum/armament_entry/cargo_gun/nanotrasen_bolt_weapons/longarm/cmg
