/datum/armament_entry/cargo_gun/microstar
...
/datum/armament_entry/cargo_gun/microstar/basic_energy_weapons
	subcategory = "Basic Energy Weapons"

/datum/armament_entry/cargo_gun/microstar/basic_energy_weapons/disabler
	item_type = /obj/item/gun/energy/disabler
	lower_cost = CARGO_CRATE_VALUE * 2
	upper_cost = CARGO_CRATE_VALUE * 5
	stock_mult = 2

/datum/armament_entry/cargo_gun/microstar/basic_energy_weapons/mini_egun
	item_type = /obj/item/gun/energy/e_gun/mini
	lower_cost = CARGO_CRATE_VALUE * 2
	upper_cost = CARGO_CRATE_VALUE * 5

/datum/armament_entry/cargo_gun/microstar/basic_energy_weapons/sc1
	item_type = /obj/item/gun/energy/laser
	lower_cost = CARGO_CRATE_VALUE * 5
	upper_cost = CARGO_CRATE_VALUE * 9
	stock_mult = 2

/datum/armament_entry/cargo_gun/microstar/basic_energy_weapons/sc2
	item_type = /obj/item/gun/energy/e_gun
	lower_cost = CARGO_CRATE_VALUE * 5
	upper_cost = CARGO_CRATE_VALUE * 9

/datum/armament_entry/cargo_gun/microstar/basic_energy_weapons/basic_mcr
...
/datum/armament_entry/cargo_gun/microstar/experimental_energy
	subcategory = "Experimental Energy Weapons"
	interest_required = PASSED_INTEREST
	restricted = TRUE

/datum/armament_entry/cargo_gun/microstar/experimental_energy/hellfire
	item_type = /obj/item/gun/energy/laser/hellgun
	lower_cost = CARGO_CRATE_VALUE * 8
	upper_cost = CARGO_CRATE_VALUE * 12

/datum/armament_entry/cargo_gun/microstar/experimental_energy/ion_carbine
	item_type = /obj/item/gun/energy/ionrifle/carbine
	lower_cost = CARGO_CRATE_VALUE * 8
	upper_cost = CARGO_CRATE_VALUE * 12

/datum/armament_entry/cargo_gun/microstar/experimental_energy/xray_gun
	item_type = /obj/item/gun/energy/xray
	lower_cost = CARGO_CRATE_VALUE * 10
	upper_cost = CARGO_CRATE_VALUE * 15

/datum/armament_entry/cargo_gun/microstar/experimental_energy/tesla_cannon
...
/datum/armament_entry/cargo_gun/microstar/mcr_attachments
	subcategory = "Microfusion Attachment Kits"
	interest_addition = COMPANY_INTEREST_GAIN_AVERAGE

/datum/armament_entry/cargo_gun/microstar/mcr_attachments/hellfire
...
/datum/armament_entry/cargo_gun/microstar/mcr_attachments/scatter
...
/datum/armament_entry/cargo_gun/microstar/mcr_attachments/lance
...
/datum/armament_entry/cargo_gun/microstar/mcr_attachments/repeater
...
/datum/armament_entry/cargo_gun/microstar/mcr_attachments/tacticool
...
/datum/armament_entry/cargo_gun/microstar/mcr_upgrades
	subcategory = "Microfusion Attachment Kits"
	interest_addition = COMPANY_INTEREST_GAIN_AVERAGE

/datum/armament_entry/cargo_gun/microstar/mcr_upgrades/stabilizer
	item_type = /obj/item/microfusion_cell_attachment/stabiliser
	lower_cost = CARGO_CRATE_VALUE * 0.5
	upper_cost = CARGO_CRATE_VALUE
	stock_mult = 3

/datum/armament_entry/cargo_gun/microstar/mcr_upgrades/enhanced_part_kit
...
/datum/armament_entry/cargo_gun/microstar/mcr_upgrades/capacity_booster
...
/datum/armament_entry/cargo_gun/microstar/mcr_upgrades/advanced_part_kit
...
/datum/armament_entry/cargo_gun/microstar/mcr_upgrades/selfcharge
...
/datum/armament_entry/cargo_gun/microstar/mcr_upgrades/bluespace_part_kit
	name = "microfusion advanced parts"
