...
/datum/chemical_reaction/cum_in_a_hot_tub/semen
	results = list(/datum/reagent/consumable/ethanol/cum_in_a_hot_tub_semen = 3)
	required_reagents = list(/datum/reagent/consumable/ethanol/vodka = 2, /datum/reagent/cum = 1, /datum/reagent/consumable/ethanol/irish_cream = 0.1)
