...
/proc/get_all_jobs() //All on-station jobs go here.
	return list("Assistant", "Captain", "Head of Personnel", "Bartender", "Cook", "Botanist", "Quartermaster", "Cargo Technician",
				...
				"Research Director", "Scientist", "Roboticist", "Head of Security", "Warden", "Detective", "Security Officer", "Security Medic", "Security Sergeant", "Prisoner", "Blueshield")
...
/proc/get_all_job_icons() //For all existing HUD icons, Things a HoP or someone with an agent card might realistically apply,  but not a real job. Also ghost role / event stuffs.
	...
	"Research Officer","Special Ops Officer","Private Security Force","CentCom Commander","Service Guest","Gue#st Comedian","Private Trader","Independent Technician","Long Term Patient","Research Subject","Independent Researcher","Security Contractor", "DonkCo Diplomat",
