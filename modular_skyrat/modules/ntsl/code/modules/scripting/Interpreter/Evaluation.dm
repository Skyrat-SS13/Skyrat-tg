...
/n_Interpreter
/n_Interpreter/proc/Eval(node/expression/exp, scope/scope)
...
/n_Interpreter/proc/EvalOperator(node/expression/operator/exp, scope/scope)
...
/n_Interpreter/proc/Add(a, b, scope, node)
	...
	if(isnull(a) || isnull(b))
		...
		return null
	return a+b
/n_Interpreter/proc/Subtract(a, b, scope, node)
	if(isnull(a) || isnull(b))
		RaiseError(new/runtimeError/TypeMismatch("-", a, b), scope, node)
		return null
	return a-b
/n_Interpreter/proc/Divide(a, b, scope, node)
	if(isnull(a) || isnull(b))
		RaiseError(new/runtimeError/TypeMismatch("/", a, b), scope, node)
		return null
	if(b)
	...
	//ReleaseSingularity()
	return null
/n_Interpreter/proc/Multiply(a, b, scope, node)
	if(isnull(a) || isnull(b))
		RaiseError(new/runtimeError/TypeMismatch("*", a, b), scope, node)
		return null
	return a*b
/n_Interpreter/proc/Modulo(a, b, scope, node)
	if(isnull(a) || isnull(b))
		RaiseError(new/runtimeError/TypeMismatch("%", a, b), scope, node)
		return null
	return a%b
/n_Interpreter/proc/Power(a, b, scope, node)
	if(isnull(a) || isnull(b))
		RaiseError(new/runtimeError/TypeMismatch("**", a, b), scope, node)
		return null
	return a**b
