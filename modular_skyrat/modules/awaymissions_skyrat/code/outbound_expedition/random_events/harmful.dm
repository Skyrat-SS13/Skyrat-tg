...
/datum/outbound_random_event/harmful/scrappers
	name = "Autonomous Scrappers"
	weight = 6

/datum/outbound_random_event/harmful/scrappers/on_select()
	OUTBOUND_CONTROLLER
...
/datum/outbound_random_event/harmful/scrappers/clear_objective()
	OUTBOUND_CONTROLLER
	outbound_controller.current_event = null
	outbound_controller.give_objective_all(outbound_controller.objectives[/datum/outbound_objective/cryo])

/datum/outbound_random_event/harmful/scrappers/proc/summon_da_bot()
