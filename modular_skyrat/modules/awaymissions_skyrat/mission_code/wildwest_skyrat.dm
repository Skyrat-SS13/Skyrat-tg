...
/obj/effect/mob_spawn/human/wildwest_syndicate
	...
	desc = "They've been here long, far too long. Your superiors have gone insane but at least you still have that revolver..."
	icon = 'icons/obj/machines/sleeper.dmi'
	icon_state = "sleeper_s"
	density = TRUE
	roundstart = FALSE
	death = FALSE
	short_desc = "A scientist lost to time within an evil and everchanging labyrinth. Try to wait for the Vanguard to get close before you take this role."
