/datum/mod_theme/covert
	name = "covert"
	desc = "A top-tier MODSuit modificaiton of the already modified contractor's suit, fit for a real stealth operative."
	extended_desc = "A rare depart from the Syndicate's usual color scheme, the Covert MODsuit is produced and manufactured \
	...
	armor = list(MELEE = 30, BULLET = 60, LASER = 40, ENERGY = 30, BOMB = 30, BIO = 30, FIRE = 100, ACID = 100, WOUND = 25)
