...
#define CME_MINIMAL_FREQUENCY_LOWER 25 * 0.75 //The lower time range for cme bubbles to appear.
#define CME_MINIMAL_FREQUENCY_UPPER 30 * 0.75 //The higher time range for cme bubbles to appear.
...
#define CME_MODERATE_FREQUENCY_LOWER 20 * 0.75
#define CME_MODERATE_FREQUENCY_UPPER 25 * 0.75
...
#define CME_EXTREME_FREQUENCY_LOWER 15 * 0.75
#define CME_EXTREME_FREQUENCY_UPPER 20 * 0.75
...
#define CME_ARMAGEDDON_FREQUENCY_LOWER 5 * 0.75
#define CME_ARMAGEDDON_FREQUENCY_UPPER 7 * 0.75
