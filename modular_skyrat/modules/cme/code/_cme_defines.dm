...
#define CME_MINIMAL_START_LOWER 180 * 0.5 //The lowest amount of time for the event to start from the announcement. - Prep time
#define CME_MINIMAL_START_UPPER 240 * 0.5 //The highest amount of time for the event to start from the announcement. - Prep time
...
#define CME_MODERATE_END 300 * 0.5
...
#define CME_EXTREME_END 360 * 0.5
