...
#define CME_MINIMAL_END 120 * 0.5 //The amount of time starting from THE MINIMAL START TIME for the event to end. - How long it actually lasts.
...
#define CME_MODERATE_END 120 * 0.5
...
#define CME_EXTREME_FREQUENCY_LOWER 25 * 0.5
#define CME_EXTREME_FREQUENCY_UPPER 30 * 0.5
...
#define CME_EXTREME_END 150 * 0.5
