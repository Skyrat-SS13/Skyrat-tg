...
/datum/armament_entry/hecu/secondary/pistol/glock // Not a glock anymore but uhhh idc enough to rename this
	item_type = /obj/item/gun/ballistic/automatic/pistol/luna
	max_purchase = 4
	mags_to_spawn = 3
