/obj/item/clothing/suit/armor/vest/hecu
	...
	desc = "A modular armor vest with inserted plates and armor elements that provide decent protection against most types of damage. Despite its modularity, however, you can't remove any of its elements."
...
/obj/item/clothing/suit/armor/bulletproof/hecu
	name = "ceramic vest"
	desc = "A highly modular armor vest with inserted plates and armor elements that provide decent protection against most types of damage. Despite its modularity, however, you can't remove any of those elements."
	icon_state = "combat_vest"
	inhand_icon_state = "armoralt"
	blood_overlay_type = "armor"
	icon = 'modular_skyrat/modules/awaymissions_skyrat/icons/hecucloth.dmi'
