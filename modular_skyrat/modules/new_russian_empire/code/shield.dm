/obj/item/shield/riot/pointman/nri
	...
	icon_state = "riot"
	icon = 'modular_skyrat/modules/new_russian_empire/icons/riot.dmi'
	lefthand_file = 'modular_skyrat/modules/new_russian_empire/icons/riot_left.dmi'
	righthand_file = 'modular_skyrat/modules/new_russian_empire/icons/riot_right.dmi'
	transparent = FALSE
