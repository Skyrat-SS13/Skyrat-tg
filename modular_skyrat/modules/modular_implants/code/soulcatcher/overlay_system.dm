/datum/soulcatcher_room
	...
	var/atom/movable/screen/fullscreen/carrier/current_overlay_path = /atom/movable/screen/fullscreen/carrier
...
/datum/soulcatcher_room/proc/set_overlay_for_mob(mob/living/occupant)
	...
	if(!istype(current_overlay_path))
	...
	if(new_screen.recolorable && overlay_color)
