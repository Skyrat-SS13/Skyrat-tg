...
/datum/design/nifsoft_money_sense
	...
	materials = list(/datum/material/iron = SHEET_MATERIAL_AMOUNT, /datum/material/silver = HALF_SHEET_MATERIAL_AMOUNT, /datum/material/plastic = 2000)
	category = list(RND_CATEGORY_EQUIPMENT)
...
/datum/design/soulcatcher_device
	...
	materials = list(/datum/material/iron = SHEET_MATERIAL_AMOUNT * 3, /datum/material/silver = 2000, /datum/material/bluespace = 2000)
	category = list(RND_CATEGORY_EQUIPMENT)
