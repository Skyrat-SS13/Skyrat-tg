...
/datum/nifsoft/summoner/activate()
	...
	new_item.AddComponent(/datum/component/summoned_item, TRUE, name_tag)
...
/datum/component/summoned_item/New(holographic_filter = TRUE, name_tag = "")
	. = ..()
	if(!isobj(parent))
	...
	summoned_item.name = name_tag + summoned_item.name
