...
GLOBAL_LIST_INIT(skyrat_metal_recipes, list(
	...
	new/datum/stack_recipe("metal barricade", /obj/structure/deployable_barricade/metal, 2, time = 1 SECONDS, on_solid_ground = TRUE, check_direction = TRUE),
...
GLOBAL_LIST_INIT(skyrat_plasteel_recipes, list(
	new/datum/stack_recipe("plasteel barricade", /obj/structure/deployable_barricade/metal/plasteel, 2, time = 1 SECONDS, on_solid_ground = TRUE, check_direction = TRUE),
))
...
GLOBAL_LIST_INIT(skyrat_rod_recipes, list(
	...
	new/datum/stack_recipe("guard rail", /obj/structure/deployable_barricade/guardrail, 2, time = 1 SECONDS, on_solid_ground = TRUE, check_direction = TRUE),
	new/datum/stack_recipe("wrestling ropes", /obj/structure/railing/wrestling, 3, time = 1.8 SECONDS, on_solid_ground = TRUE, check_direction = TRUE, check_density = FALSE),
))
...
GLOBAL_LIST_INIT(skyrat_wood_recipes, list(
	...
	new/datum/stack_recipe("wooden half-barricade", /obj/structure/deployable_barricade/wooden, 5, time = 2 SECONDS, on_solid_ground = TRUE, check_direction = TRUE),
...
GLOBAL_LIST_INIT(skyrat_snow_recipes, list(
	new/datum/stack_recipe("snow barricade", /obj/structure/deployable_barricade/snow, 2, on_solid_ground = true, check_direction = TRUE),
))
