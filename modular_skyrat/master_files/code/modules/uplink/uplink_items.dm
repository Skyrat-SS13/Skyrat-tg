...
/datum/uplink_item/stealthy_tools/deluxe_agent_card
	...
	cost = 15 //Since this gives the possibility for All Access, this is a BIGBOY tool. Compared to oldbases' skeleton key, though, you still have to steal it somehow.
...
/datum/uplink_item/stealthy_tools/advanced_cham_headset
	...
	cost = 25 //Also a BIGBOY tool. Though inconvienent to wield, this allows the wearer to spy and interact with any one frequency they desire, even without the proper encryption key, along with flashbang protection and loudmode. Cannot breach syndiecomms by itself.
