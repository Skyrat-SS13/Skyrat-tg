...
/datum/preference/text/headshot
	...
	var/static/link_regex = regex("i.gyazo.com|a.l3n.co|b.l3n.co|c.l3n.co|images2.imgbox.com|thumbs2.imgbox.com") //gyazo, discord, lensdump, imgbox
...
/datum/preference/text/headshot/is_valid(value)
	...
	if(find_index != 9)
		to_chat(usr, span_warning("The image must be hosted on one of the following sites: 'Gyazo, Discord, Lensdump, Imgbox'"))
		return
