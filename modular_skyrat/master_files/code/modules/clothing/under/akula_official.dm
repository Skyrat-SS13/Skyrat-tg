...
/obj/item/clothing/under/rank/azulean/old_blood
	...
	extended_desc = "These outfits are known to normally be accessorized with gold trims and other rare metals, \
...
/obj/item/clothing/under/rank/azulean/upstart
	...
	extended_desc = "These outfits rebuke tradition to incorporate the use of imported leather, using reinforced clasps instead of shiny golden buttons. \n\n\
