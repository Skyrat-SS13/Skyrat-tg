#define SHORTS_PANTS_SHIRTS_OBJFILE 'modular_skyrat/master_files/icons/obj/clothing/under/shorts_pants_shirts.dmi'
#define SHORTS_PANTS_SHIRTS_MOBFILE 'modular_skyrat/master_files/icons/mob/clothing/under/shorts_pants_shirts.dmi'
...
/obj/item/clothing/under/pants/skyrat
	icon = SHORTS_PANTS_SHIRTS_OBJFILE
	worn_icon = SHORTS_PANTS_SHIRTS_MOBFILE
