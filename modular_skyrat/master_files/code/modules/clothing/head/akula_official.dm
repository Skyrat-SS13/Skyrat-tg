...
/obj/item/clothing/head/hats/caphat/azulean/old_blood
	...
	extended_desc = "Comfortable and lightweight, the purpose of this cap has gradually shifted to becoming yet another method to flex rank. \n\n\
...
/obj/item/clothing/head/hats/caphat/azulean/upstart
	...
	extended_desc = "Combining ideas from both the NRI and the Old Principalities, this cloneleather cap was made to be both inexpensive and easier to maintain than the elaborate headpieces worn by the older nobility. \
