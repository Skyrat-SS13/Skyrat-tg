...
/datum/examine_panel/ui_data(mob/user)
	...
	if(preferences)
		...
		if(!CONFIG_GET(flag/disable_antag_opt_in_preferences))
			...
			ooc_notes += "<b>Current Antag Opt-In Status</b>: [GLOB.antag_opt_in_strings[num2text(effective_opt_in_level)]]\n"
			ooc_notes += "Antag Opt-In Status: [GLOB.antag_opt_in_strings[num2text(antag_prefs)]]\n"
			ooc_notes += "\n"
