...
/datum/quirk/linguist
	...
	gain_text = "<span class='notice'>Your brain seems more equipped to handle different modes of conversation.</span>"
	lose_text = "<span class='danger'>Your grasp of the finer points of Draconic idioms fades away.</span>"
