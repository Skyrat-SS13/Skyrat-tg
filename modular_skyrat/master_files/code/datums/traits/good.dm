...
/datum/quirk/water_aspect
	...
	desc = "(Aquatic innate) Underwater societies are home to you, space ain't much different."
	value = 2
	mob_trait = TRAIT_WATER_ASPECT
	gain_text = "<span class='notice'>You feel like you can control water. (Say *turf to cast)</span>"
...
/datum/quirk/webbing_aspect
	...
	desc = "(Insect innate) Insect folk capable of weaving aren't unfamiliar with receiving envy from those lacking a natural 3D printer."
	value = 2
	mob_trait = TRAIT_WEBBING_ASPECT
	gain_text = "<span class='notice'>You could easily spin a web.  (Say *turf to cast)</span>"
...
/datum/quirk/floral_aspect
	...
	desc = "(Podperson innate) Kudzu research isn't pointless, rapid photosynthesis technology is here!"
	value = 2
	mob_trait = TRAIT_FLORAL_ASPECT
	gain_text = "<span class='notice'>You feel like you can grow vines. (Say *turf to cast)</span>"
