...
/datum/quirk/personalspace
	name = "Personal Space"
	desc = "You'd rather people didn't lick you or touch your ass."
	gain_text = span_notice("You feel an aversion to being licked or having your ass touched.")
	lose_text = span_notice("You're less concerned about people licking you or touching your ass.")
	medical_record_text = "Patient demonstrates negative reactions to being licked or having their posterior touched."
	value = 0
