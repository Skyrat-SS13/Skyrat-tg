/datum/disease/hypoglycemia
	...
	desc = "If left untreated the subject will suffer from lethargy, dizziness, periodic loss of conciousness, and death."
	...
	switch(stage)
		if(1)
			...
			if(SPT_PROB(2.5, seconds_per_tick))
				...
				affected_mob.set_eye_blur_if_lower(15 SECONDS)
			if(SPT_PROB(2.5, seconds_per_tick))
		...
		if(2, 3)
			...
			if(SPT_PROB(2.5, seconds_per_tick))
				...
				affected_mob.emote("sway")
				affected_mob.set_dizzy_if_lower(25 SECONDS)
			if(stage == 3)
