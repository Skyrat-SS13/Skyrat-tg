...
/datum/id_trim/job/expeditionary_trooper
	...
	full_access = list(ACCESS_MAINT_TUNNELS, ACCESS_EVA, ACCESS_EXTERNAL_AIRLOCKS, ACCESS_TELEPORTER, ACCESS_GATEWAY, ACCESS_TECH_STORAGE, ACCESS_SEC_DOORS, ACCESS_CENT_GENERAL)
	minimal_access = list(ACCESS_MAINT_TUNNELS, ACCESS_EVA, ACCESS_EXTERNAL_AIRLOCKS, ACCESS_TELEPORTER, ACCESS_GATEWAY, ACCESS_TECH_STORAGE, ACCESS_SEC_DOORS, ACCESS_CENT_GENERAL)
