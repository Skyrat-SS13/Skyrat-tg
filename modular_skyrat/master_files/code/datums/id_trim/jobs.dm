...
/datum/id_trim/job/blueshield
	...
	wildcard_access = list(ACCESS_BLUESHIELD)
	...
	minimal_wildcard_access = list(ACCESS_BLUESHIELD)
...
/datum/id_trim/job/security_medic
	...
	access = list(ACCESS_SECURITY, ACCESS_SEC_DOORS, ACCESS_BRIG, ACCESS_COURT, ACCESS_MECH_SECURITY, ACCESS_MORGUE, ACCESS_WEAPONS,
				ACCESS_FORENSICS_LOCKERS, ACCESS_MINERAL_STOREROOM, ACCESS_MEDICAL, ACCESS_MORGUE, ACCESS_SURGERY, ACCESS_ENTER_GENPOP, ACCESS_LEAVE_GENPOP)
