...
/datum/id_trim/job/head_of_personnel
	minimal_access = list(ACCESS_AI_UPLOAD, ACCESS_ALL_PERSONAL_LOCKERS, ACCESS_AUX_BASE, ACCESS_BAR, ACCESS_BARBER, ACCESS_CARGO, ACCESS_CHAPEL_OFFICE,
...
/datum/id_trim/job/quartermaster
	minimal_access = list(ACCESS_AUX_BASE, ACCESS_CARGO, ACCESS_HEADS, ACCESS_KEYCARD_AUTH, ACCESS_MAILSORTING, ACCESS_MAINT_TUNNELS, ACCESS_MECH_MINING, ACCESS_MINING_STATION,
					ACCESS_MINERAL_STOREROOM, ACCESS_MINING, ACCESS_QM, ACCESS_RC_ANNOUNCE, ACCESS_SEC_DOORS, ACCESS_VAULT, ACCESS_GUNDEALER)
