...
GLOBAL_LIST_INIT(uncommon_loot, list(//uncommon: useful items
	...
	list( //Cartridges
		/obj/item/computer_hardware/hard_drive/role/atmos = 100,
		/obj/item/computer_hardware/hard_drive/role/captain = 5,
		/obj/item/computer_hardware/hard_drive/role/ce = 5,
		/obj/item/computer_hardware/hard_drive/role/chemistry = 50,
		/obj/item/computer_hardware/hard_drive/role/cmo = 5,
		/obj/item/computer_hardware/hard_drive/role/detective = 50,
		/obj/item/computer_hardware/hard_drive/role/engineering = 50,
		/obj/item/computer_hardware/hard_drive/role/head = 5,
		/obj/item/computer_hardware/hard_drive/role/hop = 5,
		/obj/item/computer_hardware/hard_drive/role/hos = 5,
		/obj/item/computer_hardware/hard_drive/role/lawyer = 50,
		/obj/item/computer_hardware/hard_drive/role/medical = 50,
		/obj/item/computer_hardware/hard_drive/role/quartermaster = 5,
		/obj/item/computer_hardware/hard_drive/role/rd = 5,
		/obj/item/computer_hardware/hard_drive/role/roboticist = 50,
		/obj/item/computer_hardware/hard_drive/role/security = 50,
		/obj/item/computer_hardware/hard_drive/role/signal = 100,
		/obj/item/computer_hardware/hard_drive/role/virus/clown = 5,
		/obj/item/computer_hardware/hard_drive/role/virus/mime = 5
	) = 50,
	list( //Bot assemblies
