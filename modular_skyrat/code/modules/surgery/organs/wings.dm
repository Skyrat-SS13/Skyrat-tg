/obj/item/organ/wings
	name = "wings"
	description = "A pair of wings. Those may or may not allow you to fly... or at the very least flap."
...
/obj/item/organ/wings/moth	
	name = "moth wings"
	description = "A pair of fuzzy moth wings."
...
/obj/item/organ/wings/flight/angel
	name = "angel wings"
	description = "A pair of magnificent, feathery wings. They look strong enough to lift you up in the air."
	mutantpart_info = list(MUTANT_INDEX_NAME = "Angel", MUTANT_INDEX_COLOR_LIST = list("FFF"))

/obj/item/organ/wings/flight/dragon
	name = "dragon wings"
	description = "A pair of intimidating, membranous wings. They look strong enough to lift you up in the air."
	mutantpart_info = list(MUTANT_INDEX_NAME = "Dragon", MUTANT_INDEX_COLOR_LIST = list("800"))

/obj/item/organ/wings/flight/megamoth
	name = "megamoth wings"
	description = "A pair of horrifyingly large, fuzzy wings. They look strong enough to lift you up in the air."
