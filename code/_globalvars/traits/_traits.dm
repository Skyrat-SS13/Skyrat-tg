...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/mob = list(
		...
		//"TRAIT_NO_PLASMA_TRANSFORM" = TRAIT_NO_PLASMA_TRANSFORM, TODO - These require transformation sting pr
		...
		//"TRAIT_STASIS" = TRAIT_STASIS, TODO - These require transformation sting pr
		...
		//"TRAIT_UNHUSKABLE" = TRAIT_UNHUSKABLE, TODO - These require transformation sting pr
