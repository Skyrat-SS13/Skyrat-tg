...
GLOBAL_LIST_INIT(channel_tokens, list(
	...
	RADIO_CHANNEL_SOLFED = RADIO_TOKEN_SOLFED, //SKYRAT EDIT ADDITION - CORPORATE DIPLOMAT
	RADIO_CHANNEL_ARMADYNE = RADIO_TOKEN_ARMADYNE, //SKYRAT EDIT ADDITION - CORPORATE DIPLOMAT
