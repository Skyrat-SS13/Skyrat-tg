...
/obj/item/encryptionkey/heads/captain
	name = "\proper the station admiral's encryption key"
...
/obj/item/encryptionkey/heads/rd
	name = "\proper the chief research officer's encryption key"
	icon_state = "rd_cypherkey"
	channels = list(RADIO_CHANNEL_SCIENCE = 1, RADIO_CHANNEL_COMMAND = 1)

/obj/item/encryptionkey/heads/hos
	name = "\proper the chief master at arms' encryption key"
	icon_state = "hos_cypherkey"
	channels = list(RADIO_CHANNEL_SECURITY = 1, RADIO_CHANNEL_COMMAND = 1)

/obj/item/encryptionkey/heads/ce
	name = "\proper the chief engineering officer's encryption key"
...
/obj/item/encryptionkey/heads/hop
	name = "\proper the corporate liasion's encryption key"
