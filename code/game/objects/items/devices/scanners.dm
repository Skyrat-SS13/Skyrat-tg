...
/obj/item/healthanalyzer/attack(mob/living/M, mob/living/carbon/human/user)
	...
	if ((HAS_TRAIT(user, TRAIT_CLUMSY) || HAS_TRAIT(user, TRAIT_DUMB)) && prob(50))
		...
		to_chat(user, "<span class='info'>Analyzing results for The floor:\n\tOverall status: <b>Healthy</b></span>\
				...
				\n<span class='info'>\tDamage specifics: <font color='#33cc99'>0</font>-<font color='green'>0</font>-<font color='#FF8000'>0</font>-<font color='red'>0</font></span>\
	...
	if(iscarbon(M) && mode == SCANNER_VERBOSE)
		...
		if(length(damaged)>0 || oxy_loss>0 || tox_loss>0 || fire_loss>0)
			var/dmgreport = "<span class='info ml-1'>General status:</span>\
							...
							<tr><td><font color='#33cc99'>Overall:</font></td>\
							...
							<td><font color='#66cccc'>[CEILING(oxy_loss,1)]</font></td></tr>"

							// ^ Skyrat color change, #66cccc was blue, #99cc99 was #0000CC
			...
			render_list += dmgreport // tables do not need extra linebreak
				// Skyrat color change, #66cc99 was #0000CC
	...
	if(ishuman(M))
		...
		if (H.internal_organs && H.internal_organs.len)
			...
			var/toReport = "<span class='info ml-1'>Organs:</span>\
				<table class='ml-2'><tr>\
				<td style='width:6em;'><font color='#66cc99'><b>Organ</b></font></td>\
				[advanced ? "<td style='width:3em;'><font color='#66cccc'><b>Dmg</b></font></td>" : ""]\
				<td style='width:12em;'><font color='#66cc99'><b>Status</b></font></td>"
			...
			for(var/obj/item/organ/organ in H.internal_organs)
				...
				if (status != "")
					...
					toReport += "<tr><td><font color='#66cc99'>[organ.name]</font></td>\
						[advanced ? "<td><font color='#66cc99'>[CEILING(organ.damage,1)]</font></td>" : ""]\
						<td>[status]</td></tr>"
		// ^ Skyrat color change, #0000CC to #66cc99
