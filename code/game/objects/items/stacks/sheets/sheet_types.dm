...
>>>>>>> ca229574f68 (Removes AI and Charge parts from tablets, adds support for more later. (#70012))
	null, \
	...
	new/datum/stack_recipe("wrestling turnbuckle", /obj/structure/wrestling_corner, 3, time = 25, one_per_turf = TRUE, on_floor = TRUE), \
...
GLOBAL_LIST_INIT(wood_recipes, list ( \
	...
	new/datum/stack_recipe("Wooden barricade", /obj/structure/deployable_barricade/wooden, 2, time = 1 SECONDS, one_per_turf = TRUE, on_floor = TRUE), \
	null, \
