...
/obj/item/crowbar/power/syndicate
	//name = "Syndicate jaws of life" //SKYRAT EDIT: Reverts the name to just a regular Jaws.
	desc = "A set of jaws of life, compressed through the magic of science. This one has a sinister black and red paintjob and more robust hydraulics." //Skyrat Edit, was "A re-engineered copy of Nanotrasen's standard jaws of life. Can be used to force open airlocks in its crowbar configuration."
