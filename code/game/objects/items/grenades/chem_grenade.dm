...
/obj/item/grenade/chem_grenade/cleaner/Initialize(mapload)
	...
	beaker_one.reagents.add_reagent(/datum/reagent/space_cleaner, 10)
	beaker_two.reagents.add_reagent(/datum/reagent/cellulose, 10) // SKYRAT EDIT - Cellulose for liquid puddle cleaning
