...
/obj/item/storage/box/syndicate/contract_kit //CHANGED IN MODULAR FOLDER
	name = "Contract Kit"
	desc = "Supplied to Syndicate contractors."
	icon_state = "syndiebox"
	illustration = "writing_syndie"

/obj/item/storage/box/syndicate/contractor_loadout //CHANGED IN MODULAR FOLDER
	name = "Standard Loadout"
	desc = "Supplied to Syndicate contractors, providing their specialised space suit and chameleon uniform."
	icon_state = "syndiebox"
	illustration = "writing_syndie"

/obj/item/paper/contractor_guide //CHANGED IN MODULAR FOLDER
	name = "Contractor Guide"

/obj/item/paper/contractor_guide/Initialize(mapload) //CHANGED IN MODULAR FOLDER
