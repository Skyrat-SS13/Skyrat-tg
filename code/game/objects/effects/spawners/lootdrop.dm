...
/obj/effect/spawner/lootdrop/organ_spawner
	...
	loot = list(
		...
		// /obj/item/organ/heart/gland/plasma = 7, //SKYRAT CHANGE: REMOVES SOME GLANDS.
		// /obj/item/organ/heart/gland/transform = 5, //SKYRAT CHANGE: REMOVES SOME GLANDS.
		// /obj/item/organ/heart/gland/slime = 4, //SKYRAT CHANGE: REMOVES SOME GLANDS.
		// /obj/item/organ/heart/gland/spiderman = 5, //SKYRAT CHANGE: REMOVES SOME GLANDS.
