...
//SKYRAT EDIT BEGIN - MORE SCANNER GATE OPTIONS
#define SCANGATE_MAMMAL
#define SCANGATE_VOX
#define SCANGATE_AQUATIC
#define SCANGATE_INSECT
#define SCANGATE_XENO
#define SCANGATE_UNATHI
#define SCANGATE_TAJARAN
#define SCANGATE_VULPKANIN
#define SCANGATE_IPC
#define SCANGATE_SYNTHLIZ
#define SCANGATE_SYNTHMAMMAL
#define SCANGATE_SYNTHHUMAN

#define SCANGATE_GENDER
//SKYRAT EDIT END - MORE SCANNER GATE OPTIONS
