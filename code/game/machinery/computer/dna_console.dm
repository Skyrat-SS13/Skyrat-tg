		...
		if("crispr")
			...
			if(new_sequence)
				...
				if(prob(60))
					...
					scanner_occupant.ForceContractDisease(random_disease, del_on_fail = TRUE) // SKYRAT EDIT - RESPECTING VIRUS IMMUNITY - ORIGINAL: random_disease.try_infect(scanner_occupant, FALSE)
				else if (prob(30))
