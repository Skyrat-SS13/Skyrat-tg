...
/datum/atom_hud/data/human/security/advanced
	hud_icons = list(ID_HUD, IMPTRACK_HUD, IMPLOYAL_HUD, IMPCHEM_HUD, WANTED_HUD, LOICENSE_HUD) // SKYRAT EDIT: ADDED LOICENSE_HUD

// SKYRAT EDIT ADDITION: Gun Dealer HUD
/datum/atom_hud/data/human/gun
	hud_icons = list(LOICENSE_HUD)
// SKYRAT EDIT END
...
/mob/living/carbon/human/proc/sec_hud_set_ID()
	...
	// SKYRAT EDIT BEGIN - GUN PERMIT HUD ICON
	var/image/permit_holder = hud_list[LOICENSE_HUD]
