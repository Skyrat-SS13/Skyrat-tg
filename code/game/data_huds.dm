...
/mob/living/carbon/med_hud_set_status()
	...
	if(HAS_TRAIT(src, TRAIT_XENO_HOST))
		...
		if((key || get_ghost(FALSE, FALSE) || GetComponent(/datum/component/previous_body)) && (can_defib() & DEFIB_REVIVABLE_STATES)) // SKYRAT EDIT : OG : if((key || get_ghost(FALSE, TRUE)) && (can_defib() & DEFIB_REVIVABLE_STATES))
