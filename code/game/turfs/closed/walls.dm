...
/turf/closed/wall
	...
	//canSmoothWith = list(SMOOTH_GROUP_WALLS) ORIGINAL
	canSmoothWith = list(SMOOTH_GROUP_WALLS, SMOOTH_GROUP_AIRLOCK, SMOOTH_GROUP_WINDOW_FULLTILE)//SKYRAT EDIT CHANGE
