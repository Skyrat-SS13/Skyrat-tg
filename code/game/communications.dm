...
GLOBAL_LIST_INIT(radiochannels, list(
	...
	RADIO_CHANNEL_SOLFED = FREQ_SOLFED, //SKYRAT EDIT ADDITION - CORPORATE DIPLOMAT
	RADIO_CHANNEL_ARMADYNE = FREQ_ARMADYNE, //SKYRAT EDIT ADDITION - CORPORATE DIPLOMAT
...
GLOBAL_LIST_INIT(reverseradiochannels, list(
	...
	"[FREQ_SOLFED]" = RADIO_CHANNEL_SOLFED, // SKYRAT EDIT ADDITION - CORPORATE DIPLOMAT
	"[FREQ_ARMADYNE]" = RADIO_CHANNEL_ARMADYNE, //SKYRAT EDIT ADDITION - CORPORATE DIPLOMAT
