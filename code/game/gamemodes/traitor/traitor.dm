...
/datum/game_mode/traitor
	...
	protected_jobs = list("Prisoner","Security Officer", "Security Medic", "Security Sergeant", "Civil Disputes Officer", "Warden", "Blueshield", "Detective", "Head of Security", "Captain") //SKYRAT EDIT CHANGE - SEC_HAUL
	required_players = 0
	required_enemies = 1
