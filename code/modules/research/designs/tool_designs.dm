...
//	departmental_flags = DEPARTMENTAL_FLAG_ENGINEERING //ORIGINAL
	departmental_flags = DEPARTMENTAL_FLAG_SCIENCE | DEPARTMENTAL_FLAG_ENGINEERING //SKYRAT EDIT CHANGE - EXTRATOOLS
