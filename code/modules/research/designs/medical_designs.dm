...
/datum/design/emergency_bed
	...
	build_type = PROTOLATHE | AWAY_LATHE
	materials = list(/datum/material/titanium = SHEET_MATERIAL_AMOUNT * 2.7, /datum/material/plastic = SHEET_MATERIAL_AMOUNT * 1.7, /datum/material/diamond = SMALL_MATERIAL_AMOUNT * 5) // SKYRAT EDIT CHANGE - Removed Bluespace Crystals from the Recipe, ORIGINAL: /datum/material/bluespace = SMALL_MATERIAL_AMOUNT * 5
