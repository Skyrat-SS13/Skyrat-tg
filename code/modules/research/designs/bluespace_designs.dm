...
/datum/design/telesci_gps
	...
	id = "telesci_gps"
	build_type = PROTOLATHE | AWAY_LATHE //Skyrat Edit - Easily obtainable by anyone with two brain cells anyways. Survival pod moment.
...
/datum/design/swapper
	...
	id = "swapper"
	build_type = PROTOLATHE | AWAY_LATHE //Skyrat Edit - Please do not die please do not die
