...
/obj/item/seeds/cannabis/rainbow
	...
	mutatelist = list()
	reagents_add = list(/datum/reagent/colorful_reagent = 0.05, /datum/reagent/medicine/psicodine = 0.03, /datum/reagent/drug/happiness = 0.1, /datum/reagent/toxin/mindbreaker = 0.1, /datum/reagent/drug/thc = 0.30) // SKYRAT - EDIT MORENARCOTICS
	rarity = 40
