...
/datum/reagent/inverse/neurine/on_mob_life(mob/living/carbon/owner, delta_time, times_fired)
	...
	var/list/forbiddentraumas = list(/datum/brain_trauma/special/obsessed, // Obsessed sets the owner as an antag - I presume this will lead to problems, so we'll remove it - SKYRAT EDIT - REMOVING SPLIT PERSONALITY
