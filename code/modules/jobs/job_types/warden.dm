...
/datum/outfit/job/warden
	...
	backpack_contents = list(/obj/item/melee/baton/security/loaded=1, /obj/item/clothing/head/beret/sec/peacekeeper, /obj/item/armament_token/sidearm) //SKRYAT EDIT CHANGE - SEC_HAUL - ORIGINAL: backpack_contents = list(/obj/item/melee/baton/loaded=1)
