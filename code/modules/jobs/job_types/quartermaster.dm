/datum/job/quartermaster
	...
	department_head = list("Station Admiral") //SKYRAT EDIT CHANGE
	faction = "Station"
	total_positions = 1
	spawn_positions = 1
	//supervisors = "the head of personnel" //ORIGINAL
	supervisors = "the station admiral" //SKYRAT EDIT CHANGE
...
/datum/job/quartermaster/announce(mob/living/carbon/human/H, announce_captaincy = FALSE)
	...
	if(announce_captaincy)
		SSticker.OnRoundstart(CALLBACK(GLOBAL_PROC, .proc/minor_announce, "Due to extreme staffing shortages, newly promoted Acting Admiral [H.real_name] on deck!"))
...
/datum/outfit/job/quartermaster
	...
	id = /obj/item/card/id/advanced/silver/generic //SKYRAT EDIT CHANGE
