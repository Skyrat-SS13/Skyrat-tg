...
/datum/outfit/job/hos
	...
	backpack_contents = list(/obj/item/melee/baton/security/loaded=1, /obj/item/modular_computer/tablet/preset/advanced/command=1, /obj/item/clothing/head/hos/beret/peacekeeper=1)
