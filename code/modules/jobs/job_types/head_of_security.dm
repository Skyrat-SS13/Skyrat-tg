...
/datum/job/head_of_security/get_captaincy_announcement(mob/living/captain)
	return "Due to staffing shortages, newly promoted Acting Admiral [captain.real_name] on deck!"
...
/datum/outfit/job/hos
	...
	gloves = /obj/item/clothing/gloves/combat //SKYRAT EDIT CHANGE - SEC_HAUL - ORIGINAL: gloves = /obj/item/clothing/gloves/color/black
