...
/datum/outfit/job/security
	...
	backpack_contents = list(/obj/item/melee/classic_baton/peacekeeper,/obj/item/clothing/head/helmet/sec/peacekeeper, /obj/item/armament_token/sidearm) //SKYRAT EDIT CHANGE - SEC_HAUL - ORIGINAL: backpack_contents = list(/obj/item/melee/baton/loaded=1)
