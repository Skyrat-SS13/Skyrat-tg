...
/turf/open/floor/material/meat
	custom_materials = list(/datum/material/meat = SHEET_MATERIAL_AMOUNT * 0.25)

/turf/open/floor/material/pizza
	custom_materials = list(/datum/material/pizza = SHEET_MATERIAL_AMOUNT * 0.25)

/turf/open/floor/material/plasmaglass
	custom_materials = list(/datum/material/alloy/plasmaglass = SHEET_MATERIAL_AMOUNT * 0.25)

/turf/open/floor/material/glass
	custom_materials = list(/datum/material/glass = SHEET_MATERIAL_AMOUNT * 0.25)

/turf/open/floor/material/plastitaniumglass
	custom_materials = list(/datum/material/alloy/plastitaniumglass = SHEET_MATERIAL_AMOUNT * 0.25)

/turf/open/floor/material/titaniumglass
	custom_materials = list(/datum/material/alloy/titaniumglass = SHEET_MATERIAL_AMOUNT * 0.25)
