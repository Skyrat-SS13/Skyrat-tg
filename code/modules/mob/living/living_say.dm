...
GLOBAL_LIST_INIT(department_radio_keys, list(
	...
	RADIO_KEY_SOLFED = RADIO_CHANNEL_SOLFED, //SKYRAT EDIT ADDITION - CORPORATE DIPLOMAT
	RADIO_KEY_ARMADYNE = RADIO_CHANNEL_ARMADYNE, //SKYRAT EDIT ADDITION - CORPORATE DIPLOMAT
