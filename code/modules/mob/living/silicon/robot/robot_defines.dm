...
/mob/living/silicon/robot
	name = "Cyborg"
	real_name = "Cyborg"
	icon = 'icons/mob/robots.dmi' //SKYRAT EDIT - Modified in modular_skyrat\modules\altborgs\code\modules\mob\living\silicon\robot\robot_defines.dm (to allow for custom transformation animations)
	icon_state = "robot"
	maxHealth = 100
	health = 100
	bubble_icon = "robot"
