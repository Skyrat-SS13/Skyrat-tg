...
/obj/docking_port/stationary/picked/whiteship
	...
	height = 22
	width = 35
	shuttlekeys = list("whiteship_meta", "whiteship_pubby", "whiteship_box", "whiteship_cere", "whiteship_kilo", "whiteship_donut", "whiteship_delta", "whiteship_ship", "whiteship_tram") //SKYRAT EDIT - Mapping - Adds shipstation and outpost's whiteship, along with tram's. Update with more as added!
