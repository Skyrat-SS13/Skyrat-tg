...
/client/Topic(href, href_list, hsrc)
	...
	if (!holder && mtl && !check_rights(R_ADMIN)) //SKYRAT EDIT: Admins should be exempt from this
	...
	if (!holder && stl && !check_rights(R_ADMIN)) //SKYRAT EDIT: Admins should be exempt from this
