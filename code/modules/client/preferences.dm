...
/datum/preferences/proc/safe_transfer_prefs_to(mob/living/carbon/human/character, icon_updates = TRUE, is_antag = FALSE)
	...
	INVOKE_ASYNC(src, PROC_REF(apply_prefs_to_sleepy), character, icon_updates) /// SKYRAT ADDITION: for a small set of usecases you need to run apply_prefs after a delay to avoid random prefs overwriting the loaded ones

/// SKYRAT ADDITION: A wrapper function for apply_prefs_to to use asynchronously when timing wonkiness happens.
