...
/datum/preferences/proc/safe_transfer_prefs_to(mob/living/carbon/human/character, icon_updates = TRUE, is_antag = FALSE)
	...
	INVOKE_ASYNC(src, PROC_REF(apply_prefs_to_sleepy), character, icon_updates) /// SKYRAT EDIT: delaying this slightly to resolve some wacky timing bugs that eat charprefs
