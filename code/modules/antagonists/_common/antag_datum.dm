...
/datum/antagonist/proc/greet()
	if(!silent)
		...
		to_chat(owner.current, span_infoplain("<span class='doyourjobidiot'>Remember that being an antagonist does not exclude you from the server rules regarding RP standards.")) //SKYRAT EDIT - RP REMINDER
