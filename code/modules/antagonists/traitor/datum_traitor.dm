...
/datum/antagonist/traitor/proc/give_codewords()
	...
	to_chat(traitor_mob, "<U><B>Your employers - be it Nanotrasen or otherwise - have provided you with the following codewords to identify fellow subversives:</B></U>")
