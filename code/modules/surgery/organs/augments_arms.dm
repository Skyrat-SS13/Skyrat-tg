...
/obj/item/organ/internal/cyberimp/arm/emp_act(severity)
	. = ..()
<<<<<<< HEAD:code/modules/surgery/organs/augments_arms.dm
	if(. & EMP_PROTECT_SELF || status == ORGAN_ROBOTIC)
=======
	if(. & EMP_PROTECT_SELF || !IS_ROBOTIC_ORGAN(src))
>>>>>>> 82cf9ea4990 (Removes shitty "status" variable on organs, makes them use organ_flags instead (#76350)):code/modules/surgery/organs/internal/cyberimp/augments_arms.dm
		return
