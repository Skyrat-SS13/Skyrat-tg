...
/obj/item/organ/internal/eyes/robotic/glow/proc/update_mob_eyes_overlay(mob/living/carbon/eye_owner = owner)
	...
	switch(eye_color_mode)
		if(MATCH_LIGHT_COLOR)
			eyes_overlay = emissive_appearance('modular_skyrat/master_files/icons/mob/human_face.dmi', "eyes_glow_gs", eye_owner, layer = -BODY_LAYER, alpha = owner.alpha) // SKYRAT EDIT CHANGE - MODULAR ICON OVERRIDE
			eyes_overlay.color = current_color_string
			eye_owner.add_overlay(eyes_overlay)
		if(USE_CUSTOM_COLOR)
			eyes_overlay_left = emissive_appearance('modular_skyrat/master_files/icons/mob/human_face.dmi', "eyes_glow_gs_left", eye_owner, layer = -BODY_LAYER, alpha = owner.alpha) // SKYRAT EDIT CHANGE - MODULAR ICON OVERRIDE
			eyes_overlay_right = emissive_appearance('modular_skyrat/master_files/icons/mob/human_face.dmi', "eyes_glow_gs_right", eye_owner, layer = -BODY_LAYER, alpha = owner.alpha) // SKYRAT EDIT CHANGE - MODULAR ICON OVERRIDE
