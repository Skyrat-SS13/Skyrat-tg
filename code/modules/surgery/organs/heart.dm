/obj/item/organ/heart
	...
	//decay_factor = 3.5 * STANDARD_ORGAN_DECAY		//designed to fail a little under 4 minutes after death //ORIGINAL
	decay_factor = 2 * STANDARD_ORGAN_DECAY	//SKYRAT EDIT CHANGE - designed to fail in ~7.5 minutes
