...
/datum/unit_test/transformation_sting/proc/setup_ling()
	...
	ling.set_species(/datum/species/lizard, icon_update = TRUE, pref_load = FALSE, ling.dna.features.Copy(), ling.dna.mutant_bodyparts.Copy(), ling.dna.body_markings.Copy()) // SKYRAT EDIT CHANGE - ORIGINAL : ling.set_species(/datum/species/lizard)
