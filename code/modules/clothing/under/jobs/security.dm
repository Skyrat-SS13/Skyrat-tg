...
/obj/item/clothing/under/rank/prisoner
	...
	greyscale_config_worn_digi = /datum/greyscale_config/jumpsuit_prison_worn/digi //SKYRAT EDIT - DigiGreyscale
...
/obj/item/clothing/under/rank/prisoner/skirt
	...
	greyscale_config_inhand_right = /datum/greyscale_config/jumpsuit_prison_inhand_right
	greyscale_config_worn = /datum/greyscale_config/jumpsuit_prison_worn
	greyscale_config_worn_digi = null //SKYRAT EDIT - DigiGreyscale
	body_parts_covered = CHEST|GROIN|ARMS
	dying_key = DYE_REGISTRY_JUMPSKIRT
	female_sprite_flags = FEMALE_UNIFORM_TOP_ONLY
	supports_variations_flags = CLOTHING_DIGITIGRADE_VARIATION_NO_NEW_ICON
