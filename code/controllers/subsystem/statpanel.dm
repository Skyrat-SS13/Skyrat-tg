...
/datum/controller/subsystem/statpanels/fire(resumed = FALSE)
	if (!resumed)
		...
		var/list/global_data = list(
			...
			"Round Time(with time dilation): [round_time > MIDNIGHT_ROLLOVER ? "[round(round_time/MIDNIGHT_ROLLOVER)]:[worldtime2text()]" : worldtime2text()]", //SKYRAT EDIT CHANGE: "Round Time: [round_time > MIDNIGHT_ROLLOVER ? "[round(round_time/MIDNIGHT_ROLLOVER)]:[worldtime2text()]" : worldtime2text()]",
