...
/datum/controller/subsystem/explosions/proc/explode(atom/epicenter, devastation_range, heavy_impact_range, light_impact_range, flash_range, adminlog, ignorecap, flame_range, silent, smoke)
	...
	var/far_dist = 0
	//far_dist += heavy_impact_range * 5 - ORIGINAL
	far_dist += heavy_impact_range * 15 //SKYRAT EDIT CHANGE - EXPLOSIONS
	...
	if(!silent)
		...
		//SKYRAT EDIT ADDITON BEGIN - EXPLOSIONS
		var/sound/creaking_explosion_sound = sound(get_sfx_skyrat("explosion_creaking"))
		var/sound/hull_creaking_sound = sound(get_sfx_skyrat("hull_creaking"))
		...
		for(var/MN in GLOB.player_list)
			...
			if(M_turf && M_turf.z == z0)
				...
				// You hear a far explosion if you're outside the blast radius. Small bombs shouldn't be heard all over the station.
					...
					/* - SKYRAT EDIT CHANGE BEGIN - EXPLOSIONS - ORIGINAL
					...
					*/
					...
					//SKYRAT EDIT CAHNGE END
						shake_camera(M, 10, clamp(baseshakeamount*0.25, 0, 2.5))
				//SKYRAT EDIT ADDITION BEGIN - EXPLOSIONS
