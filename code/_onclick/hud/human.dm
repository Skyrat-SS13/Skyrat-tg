...
/datum/hud/human/New(mob/living/carbon/human/owner)
	...
	if(owner.client?.prefs?.read_preference(/datum/preference/toggle/sex_toy))
...
/datum/hud/human/hidden_inventory_update(mob/viewer)
	...
	//SKYRAT EDIT ADDITION BEGIN - ERP_SLOT_SYSTEM
	if(screenmob.hud_used.ERP_inventory_shown && screenmob.hud_used.hud_shown && H.client.prefs?.read_preference(/datum/preference/toggle/sex_toy))
		if(H.vagina)
