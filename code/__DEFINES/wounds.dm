...
//le skyrat edit
GLOBAL_LIST_INIT(global_wound_types_synth, list(WOUND_BLUNT = list(),
...
GLOBAL_LIST_INIT(global_all_wound_types_synth, list(/datum/wound/synthetic/slash/critical, /datum/wound/synthetic/slash/severe, /datum/wound/synthetic/slash/moderate,
	...
	/datum/wound/synthetic/burn/critical, /datum/wound/synthetic/burn/severe, /datum/wound/synthetic/burn/moderate,
	/datum/wound/synthetic/muscle/severe, /datum/wound/synthetic/muscle/moderate))
