...
GLOBAL_LIST_INIT(global_wound_types, list(WOUND_BLUNT = list(/datum/wound/blunt/critical, /datum/wound/blunt/severe, /datum/wound/blunt/moderate),
		...
		WOUND_BURN = list(/datum/wound/burn/critical, /datum/wound/burn/severe, /datum/wound/burn/moderate), // SKYRAT EDIT ADDTION BEGIN - MUSCLE WOUNDS
		WOUND_MUSCLE = list(/datum/wound/muscle/severe, /datum/wound/muscle/moderate) // SKYRAT EDIT ADDITON END
		))
...
GLOBAL_LIST_INIT(global_all_wound_types, list(/datum/wound/blunt/critical, /datum/wound/blunt/severe, /datum/wound/blunt/moderate,
	...
	/datum/wound/burn/critical, /datum/wound/burn/severe, /datum/wound/burn/moderate, /datum/wound/muscle/severe, /datum/wound/muscle/moderate)) // SKYRAT EDIT ADDITION
