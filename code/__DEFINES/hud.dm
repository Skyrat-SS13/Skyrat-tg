...
*/
// SKYRAT EDIT BEGIN - This whole file for the variable viewport. IMPORTANT INFO BELOW.
// Upstream changes CAN happen here, if they are cardinals, convert them to directionals. The consequence of not is grid-based ui-icon placement instead of relative. This is not fatal.
...
#define ui_action_palette "LEFT+0:23,TOP-1:5"
