...
// Group defines
#define CULTURE_GROUP_HUMAN (BACKGROUNDS_SOLFED | BACKGROUNDS_SYNDICATE | BACKGROUNDS_NANOTRASEN | BACKGROUNDS_SYNTH | BACKGROUNDS_NRI)
// Alien as in not human, dorks.
#define CULTURE_GROUP_ALIEN (BACKGROUNDS_AKULAN | BACKGROUNDS_TAJARAN | BACKGROUNDS_LAVALAND | BACKGROUNDS_SKRELL_VULPAKIN | BACKGROUNDS_MOHGES)
#define CULTURE_GROUP_SPACE_FARING (CULTURE_GROUP_HUMAN | BACKGROUNDS_TAJARAN | BACKGROUNDS_AKULAN | BACKGROUNDS_SKRELL_VULPAKIN)
