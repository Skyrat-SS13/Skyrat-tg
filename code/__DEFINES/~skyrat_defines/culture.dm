...
#define CULTURE_SKRELL_VULP (1<<9)
#define CULTURE_MOGHES (1<<10)

// Group defines
#define CULTURE_GROUP_HUMAN (CULTURE_SOL | CULTURE_SYNDICATE | CULTURE_NT | CULTURE_SYNTH | CULTURE_NRI)
// Alien as in not human, dorks.
#define CULTURE_GROUP_ALIEN (CULTURE_AKULAN | CULTURE_TAJARAN | CULTURE_LAVALAND | CULTURE_SKRELL_VULP | CULTURE_MOGHES)
#define CULTURE_GROUP_SPACE_FARING (CULTURE_GROUP_HUMAN | CULTURE_TAJARAN | CULTURE_AKULAN | CULTURE_SKRELL_VULP)
