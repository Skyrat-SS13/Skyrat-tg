...
GLOBAL_LIST_INIT(global_wound_types_synth, list(WOUND_BLUNT = list(/datum/wound/synthetic/blunt/critical, /datum/wound/synthetic/blunt/severe, /datum/wound/synthetic/blunt/moderate),
		WOUND_SLASH = list(/datum/wound/synthetic/slash/critical, /datum/wound/synthetic/slash/severe, /datum/wound/synthetic/slash/moderate),
...
GLOBAL_LIST_INIT(global_all_wound_types_synth, list(/datum/wound/synthetic/blunt/critical, /datum/wound/synthetic/blunt/severe, /datum/wound/synthetic/blunt/moderate,
	/datum/wound/synthetic/slash/critical, /datum/wound/synthetic/slash/severe, /datum/wound/synthetic/slash/moderate,
