...
#define ZTRAITS_ICEMOONSKYRAT list(
	...
	) //Remove ZTRAIT_ICE_RUINS if anyone makes multi-z icemoon ruins, as it'll cause problems here.
...
#define ZTRAITS_OCEAN_LEVEL list(
	ZTRAIT_GRAVITY = TRUE,
	ZTRAIT_BASETURF = /turf/open/floor/plating/asteroid,
	ZTRAIT_OCEAN_RUINS = TRUE
	)

#define ZTRAITS_TRENCH_LEVEL list(
	ZTRAIT_GRAVITY = TRUE,
	ZTRAIT_BASETURF = /turf/open/floor/plating/asteroid,
	ZTRAIT_TRENCH_RUINS = TRUE
	)
