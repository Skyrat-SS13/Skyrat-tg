...
/// Increased incoming damage (1.2x burn, 1.25x brute multiplicative), numbers designed to make Teshari who take this as vulnerable as before their buff.
#define TRAIT_FRAGILE "fragility"
