...
#define CARGO_COMPANY_NAKAMURA_MODSUITS (1<<1)
#define CARGO_COMPANY_BLACKSTEEL (1<<2)
#define CARGO_COMPANY_NRI_SURPLUS (1<<3)
#define CARGO_COMPANY_DEFOREST (1<<4)
#define CARGO_COMPANY_DONK (1<<5)
