...
#define COMPANY_KZ_FRONTIER "It has a small label with <b>[span_engradio("Khisali-Zelithese Frontier Equipment")]</b> printed on it, alongside various xerxian proof-marks."
