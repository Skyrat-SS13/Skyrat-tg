...
/// File location for metalic wound descriptions // SKYRAT EDIT ADDITION BEGIN - SYNTH WOUNDS
#define METAL_SCAR_FILE "wounds/metal_scar_desc.json" // SKYRAT EDIT END
