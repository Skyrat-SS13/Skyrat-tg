...
#define BODYPART_MARKINGS_LAYER 26		//SKYRAT EDIT - customization. And also moved the above by 1
...
#define TOTAL_LAYERS			29		//KEEP THIS UP-TO-DATE OR SHIT WILL BREAK ;_; //SKYRAT EDIT - bumped to 29
