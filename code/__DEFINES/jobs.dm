...
#define DEPARTMENT_BITFLAG_SOLAR_FEDERATION (1<<11)
#define DEPARTMENT_SOLAR_FEDERATION "Solar Federation"
#define DEPARTMENT_BITFLAG_ARMADYNE_CORPORATION (1<<12)
#define DEPARTMENT_ARMADYNE_CORPORATION "Armadyne Corporation"
// SKYRAT ADDITION END
