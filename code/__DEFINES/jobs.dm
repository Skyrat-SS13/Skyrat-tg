...
#define JOB_DISPLAY_ORDER_FLEET_ADMIRAL 41 //SKYRAT EDIT ADDITON - CENTRAL ROLES BELOW HERE!
#define JOB_DISPLAY_ORDER_OPERATIONS_INSPECTOR 42
#define JOB_DISPLAY_ORDER_NANOTRASEN_REPRESENTATIVE 43
