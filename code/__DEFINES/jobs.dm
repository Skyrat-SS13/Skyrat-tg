...
#define JOB_DISPLAY_ORDER_SECURITY_SERGEANT 33 //SKYRAT EDIT ADDITON - SEC_HAUL - BUMP UP
#define JOB_DISPLAY_ORDER_DETECTIVE 34
#define JOB_DISPLAY_ORDER_SECURITY_OFFICER 35
#define JOB_DISPLAY_ORDER_JUNIOR_SECURITY_OFFICER 35
#define JOB_DISPLAY_ORDER_SECURITY_MEDIC 37 //SKYRAT EDIT ADDITON - SEC_HAUL
#define JOB_DISPLAY_ORDER_PRISONER 38
#define JOB_DISPLAY_ORDER_BRIGOFF 39 //SKYRAT EDIT ADDITON - BRIGOFF
#define JOB_DISPLAY_ORDER_BLUESHIELD 40 //SKYRAT EDIT ADDITON - BLUESHIELD
#define JOB_DISPLAY_ORDER_EXP_CORPS 41 //SKYRAT EDIT ADDITON
