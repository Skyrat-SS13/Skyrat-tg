...
#define JOB_DISPLAY_ORDER_SYNDSPACER 44 //SKYRAT EDIT ADDITION - Slot the Syndicate Spacer gets stuck in
#define JOB_DISPLAY_ORDER_SYNDICATE 45 //SKYRAT EDIT ADDITION - Generic catch-all for syndicate roles
#define JOB_DISPLAY_ORDER_GHOSTROLE 46 //SKYRAT EDIT ADDITION - Generic catch-all for ghostroles
