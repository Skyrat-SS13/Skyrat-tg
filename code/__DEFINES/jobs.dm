...
#define JOB_DISPLAY_ORDER_SIGNAL_TECHNICIAN	19	//SKYRAT EDIT ADDITION - NTSL
...
#define JOB_DISPLAY_ORDER_SECURITY_SERGEANT 34 //SKYRAT EDIT ADDITON - SEC_HAUL - BUMP UP
...
#define JOB_DISPLAY_ORDER_SECURITY_MEDIC 38 //SKYRAT EDIT ADDITON - SEC_HAUL
