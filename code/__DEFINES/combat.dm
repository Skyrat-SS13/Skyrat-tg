...
#define HEALTH_THRESHOLD_DEAD -120

#define HEALTH_THRESHOLD_NEARDEATH -110 //Not used mechanically, but to determine if someone is so close to death they hear the other side
