...
/datum/dna/proc/initialize_dna(newblood_type, create_mutation_blocks = TRUE, randomize_features = TRUE)
	...
	if(randomize_features)
		...
		features += species.randomize_features() // SKYRAT EDIT CHANGE - Use randomize_features to determine the color instead as there is more than 1 mcolor - Original: features["mcolor"] = "#[random_color()]"
