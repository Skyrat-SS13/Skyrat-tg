...
/datum/dna/proc/initialize_dna(newblood_type, create_mutation_blocks = TRUE, randomize_features = TRUE)
	...
	if(randomize_features)
		...
		features = species.randomize_features() | features // SKYRAT EDIT CHANGE START - Where applicable, replace features with the features generated by species/randomize_features() - Original: features["mcolor"] = "#[random_color()]"
