              ...
              <Stack vertical height="100%">
                {surgeries.map((surgery, index) => (
                  <Button
                    ...
                    tooltip={surgery.blocked ? (surgery.blocked_reason ?? "That surgery is unavailable!") : undefined} // SKYRAT EDIT - ORIGINAL: tooltip={surgery.blocked ? "Their body is covered!" : undefined}
                    key={surgery.name}
                    fluid
                  >
                    {surgery.name}
