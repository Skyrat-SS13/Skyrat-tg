...
## Requirements
It is a requirement of Rogue Life development that all ghost roles, antags, minor antags and event mobs of any kind must support the policy system when implemented.
